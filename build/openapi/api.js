...
(function (EndpointResponse) {
    ...
    })(StatusEnum = EndpointResponse.StatusEnum || (EndpointResponse.StatusEnum = {}));
 ...
 */
var InitiateClearingResponse;
(function (InitiateClearingResponse) {
    /**
     * @export
     * @enum {string}
     */
    ...
    })(RequestStatusEnum = InitiateClearingResponse.RequestStatusEnum || (InitiateClearingResponse.RequestStatusEnum = {}));
})(InitiateClearingResponse = exports.InitiateClearingResponse || (exports.InitiateClearingResponse = {}));
/**
 * @export
...
(function (Logo) {
    ...
    })(PositionEnum = Logo.PositionEnum || (Logo.PositionEnum = {}));
})(Logo = exports.Logo || (exports.Logo = {}));
/**
 * @export
 * @namespace Method
 */
 ...
 */
var Secure3D21AuthenticationRequest;
(function (Secure3D21AuthenticationRequest) {
    /**
     * @export
     * @enum {string}
     */
    ...
    })(ChallengeIndicatorEnum = Secure3D21AuthenticationRequest.ChallengeIndicatorEnum || (Secure3D21AuthenticationRequest.ChallengeIndicatorEnum = {}));
    /**
     * @export
     * @enum {string}
     */
    ...
    })(ChallengeWindowSizeEnum = Secure3D21AuthenticationRequest.ChallengeWindowSizeEnum || (Secure3D21AuthenticationRequest.ChallengeWindowSizeEnum = {}));
})(Secure3D21AuthenticationRequest = exports.Secure3D21AuthenticationRequest || (exports.Secure3D21AuthenticationRequest = {}));
/**
 * @export
 ...
 */
var Secure3D21AuthenticationUpdateRequest;
(function (Secure3D21AuthenticationUpdateRequest) {
    /**
     * @export
     * @enum {string}
     */
    let MethodNotificationStatusEnum;
    (function (MethodNotificationStatusEnum) {
        MethodNotificationStatusEnum["RECEIVED"] = "RECEIVED";
        MethodNotificationStatusEnum["EXPECTEDBUTNOTRECEIVED"] = "EXPECTED_BUT_NOT_RECEIVED";
        MethodNotificationStatusEnum["NOTEXPECTED"] = "NOT_EXPECTED";
    })(MethodNotificationStatusEnum = Secure3D21AuthenticationUpdateRequest.MethodNotificationStatusEnum || (Secure3D21AuthenticationUpdateRequest.MethodNotificationStatusEnum = {}));
})(Secure3D21AuthenticationUpdateRequest = exports.Secure3D21AuthenticationUpdateRequest || (exports.Secure3D21AuthenticationUpdateRequest = {}));
/**
 * @export
 * @namespace Secure3DAuthenticationResponse
 */
var Secure3DAuthenticationResponse;
(function (Secure3DAuthenticationResponse) {
    /**
     * @export
     * @enum {string}
     */
    let TypeEnum;
    (function (TypeEnum) {
        TypeEnum["_3DSECURE"] = "3D_SECURE";
    })(TypeEnum = Secure3DAuthenticationResponse.TypeEnum || (Secure3DAuthenticationResponse.TypeEnum = {}));
    /**
     * @export
     * @enum {string}
     */
    ...
    (function (VersionEnum) {
        VersionEnum["_10"] = "1.0";
        VersionEnum["_21"] = "2.1";
    })(VersionEnum = Secure3DAuthenticationResponse.VersionEnum || (Secure3DAuthenticationResponse.VersionEnum = {}));
})(Secure3DAuthenticationResponse = exports.Secure3DAuthenticationResponse || (exports.Secure3DAuthenticationResponse = {}));
/**
 * @export
...
exports.AuthenticationApiAxiosParamCreator = function (configuration) {
    return {
         ...
         */
        authenticationAccessTokensPost(contentType, clientRequestId, apiKey, timestamp, accessTokenRequest, messageSignature, options = {}) {
            ...
            const needsSerialization = ("AccessTokenRequest" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
...
exports.AuthenticationApiFp = function (configuration) {
    return {
         ...
         */
        authenticationAccessTokensPost(contentType, clientRequestId, apiKey, timestamp, accessTokenRequest, messageSignature, options) {
            const localVarAxiosArgs = exports.AuthenticationApiAxiosParamCreator(configuration).authenticationAccessTokensPost(contentType, clientRequestId, apiKey, timestamp, accessTokenRequest, messageSignature, options);
...
exports.PaymentApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        finalizeSecureTransaction(contentType, clientRequestId, apiKey, timestamp, transactionId, authenticationUpdateRequest, messageSignature, region, options = {}) {
            // verify required parameter 'contentType' is not null or undefined
            if (contentType === null || contentType === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
            const needsSerialization = ("AuthenticationUpdateRequest" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
...
exports.PaymentApiFp = function (configuration) {
    return {
         ...
         */
        finalizeSecureTransaction(contentType, clientRequestId, apiKey, timestamp, transactionId, authenticationUpdateRequest, messageSignature, region, options) {
            const localVarAxiosArgs = exports.PaymentApiAxiosParamCreator(configuration).finalizeSecureTransaction(contentType, clientRequestId, apiKey, timestamp, transactionId, authenticationUpdateRequest, messageSignature, region, options);
            return (axios = axios_1.default, basePath = BASE_PATH) => {
                const axiosRequestArgs = Object.assign(localVarAxiosArgs.options, { url: basePath + localVarAxiosArgs.url });
                return axios.request(axiosRequestArgs);
            };
...
exports.PaymentTokenApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getPaymentTokenDetails(contentType, clientRequestId, apiKey, timestamp, tokenId, messageSignature, authorization, region, storeId, options = {}) {
            // verify required parameter 'contentType' is not null or undefined
            if (contentType === null || contentType === undefined) {
...
exports.PaymentTokenApiFp = function (configuration) {
    return {
         ...
         */
        getPaymentTokenDetails(contentType, clientRequestId, apiKey, timestamp, tokenId, messageSignature, authorization, region, storeId, options) {
            const localVarAxiosArgs = exports.PaymentTokenApiAxiosParamCreator(configuration).getPaymentTokenDetails(contentType, clientRequestId, apiKey, timestamp, tokenId, messageSignature, authorization, region, storeId, options);
            return (axios = axios_1.default, basePath = BASE_PATH) => {
                const axiosRequestArgs = Object.assign(localVarAxiosArgs.options, { url: basePath + localVarAxiosArgs.url });
                return axios.request(axiosRequestArgs);
            };
