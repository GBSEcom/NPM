...
/**
    ...
    * @enum {string}
    */
var AdditionalDetailsBusinessApplicationIdentifierEnum;
(function (AdditionalDetailsBusinessApplicationIdentifierEnum) {
    AdditionalDetailsBusinessApplicationIdentifierEnum["BANKINITIATEDTRANSFER"] = "BANK_INITIATED_TRANSFER";
    AdditionalDetailsBusinessApplicationIdentifierEnum["WALLETTRANSFER"] = "WALLET_TRANSFER";
    AdditionalDetailsBusinessApplicationIdentifierEnum["ACCOUNTTOACCOUNT"] = "ACCOUNT_TO_ACCOUNT";
    AdditionalDetailsBusinessApplicationIdentifierEnum["TOPOFF"] = "TOP_OFF";
    AdditionalDetailsBusinessApplicationIdentifierEnum["FUNDTRANSFER"] = "FUND_TRANSFER";
    AdditionalDetailsBusinessApplicationIdentifierEnum["ZERODOLLARAUTHORIZATION"] = "ZERO_DOLLAR_AUTHORIZATION";
})(AdditionalDetailsBusinessApplicationIdentifierEnum = exports.AdditionalDetailsBusinessApplicationIdentifierEnum || (exports.AdditionalDetailsBusinessApplicationIdentifierEnum = {}));
/**
    * @export
    * @enum {string}
    */
...
/**
    ...
    * @enum {string}
    */
var ManagedRedirectPaymentMethodPaymentMethodTypeEnum;
(function (ManagedRedirectPaymentMethodPaymentMethodTypeEnum) {
    ManagedRedirectPaymentMethodPaymentMethodTypeEnum["APPLEPAY"] = "APPLEPAY";
    ManagedRedirectPaymentMethodPaymentMethodTypeEnum["BCMCAPM"] = "BCMC_APM";
    ManagedRedirectPaymentMethodPaymentMethodTypeEnum["GOOGLEPAY"] = "GOOGLEPAY";
    ManagedRedirectPaymentMethodPaymentMethodTypeEnum["IDEAL"] = "IDEAL";
    ManagedRedirectPaymentMethodPaymentMethodTypeEnum["INDIAWALLET"] = "INDIAWALLET";
})(ManagedRedirectPaymentMethodPaymentMethodTypeEnum = exports.ManagedRedirectPaymentMethodPaymentMethodTypeEnum || (exports.ManagedRedirectPaymentMethodPaymentMethodTypeEnum = {}));
/**
    * @export
    * @enum {string}
    */
var ManagedRedirectResponseRequestStatusEnum;
(function (ManagedRedirectResponseRequestStatusEnum) {
    ManagedRedirectResponseRequestStatusEnum["SUCCESS"] = "SUCCESS";
    ManagedRedirectResponseRequestStatusEnum["VALIDATIONFAILED"] = "VALIDATION_FAILED";
    ManagedRedirectResponseRequestStatusEnum["PROCESSINGFAILED"] = "PROCESSING_FAILED";
    ManagedRedirectResponseRequestStatusEnum["FAILURE"] = "FAILURE";
})(ManagedRedirectResponseRequestStatusEnum = exports.ManagedRedirectResponseRequestStatusEnum || (exports.ManagedRedirectResponseRequestStatusEnum = {}));
/**
 * Type of transaction to perform with ManagedRedirectRequest. Primary transaction types in requests include \'SALE\', \'PREAUTH\', \'PAYER_AUTH\'.
 * @export
 * @enum {string}
 */
var ManagedRedirectTransactionType;
(function (ManagedRedirectTransactionType) {
    ManagedRedirectTransactionType["SALE"] = "SALE";
    ManagedRedirectTransactionType["PREAUTH"] = "PREAUTH";
    ManagedRedirectTransactionType["PAYERAUTH"] = "PAYER_AUTH";
})(ManagedRedirectTransactionType = exports.ManagedRedirectTransactionType || (exports.ManagedRedirectTransactionType = {}));
/**
    * @export
    * @enum {string}
    */
...
(function (PaymentMethodType) {
    ...
    PaymentMethodType["CONEKTA"] = "CONEKTA";
...
/**
    ...
    * @enum {string}
    */
var RedirectAttributesChallengeIndicatorEnum;
(function (RedirectAttributesChallengeIndicatorEnum) {
    RedirectAttributesChallengeIndicatorEnum["_01"] = "01";
    RedirectAttributesChallengeIndicatorEnum["_02"] = "02";
    RedirectAttributesChallengeIndicatorEnum["_03"] = "03";
    RedirectAttributesChallengeIndicatorEnum["_04"] = "04";
})(RedirectAttributesChallengeIndicatorEnum = exports.RedirectAttributesChallengeIndicatorEnum || (exports.RedirectAttributesChallengeIndicatorEnum = {}));
/**
    * @export
    * @enum {string}
    */
var RedirectAttributesThreeDSEmvCoMessageCategoryEnum;
(function (RedirectAttributesThreeDSEmvCoMessageCategoryEnum) {
    RedirectAttributesThreeDSEmvCoMessageCategoryEnum["_01"] = "01";
    RedirectAttributesThreeDSEmvCoMessageCategoryEnum["_02"] = "02";
    RedirectAttributesThreeDSEmvCoMessageCategoryEnum["_80"] = "80";
})(RedirectAttributesThreeDSEmvCoMessageCategoryEnum = exports.RedirectAttributesThreeDSEmvCoMessageCategoryEnum || (exports.RedirectAttributesThreeDSEmvCoMessageCategoryEnum = {}));
/**
    * @export
    * @enum {string}
    */
var RedirectAttributesThreeDSTransactionTypeEnum;
(function (RedirectAttributesThreeDSTransactionTypeEnum) {
    RedirectAttributesThreeDSTransactionTypeEnum["_01"] = "01";
    RedirectAttributesThreeDSTransactionTypeEnum["_03"] = "03";
    RedirectAttributesThreeDSTransactionTypeEnum["_10"] = "10";
    RedirectAttributesThreeDSTransactionTypeEnum["_11"] = "11";
    RedirectAttributesThreeDSTransactionTypeEnum["_28"] = "28";
})(RedirectAttributesThreeDSTransactionTypeEnum = exports.RedirectAttributesThreeDSTransactionTypeEnum || (exports.RedirectAttributesThreeDSTransactionTypeEnum = {}));
/**
    * @export
    * @enum {string}
    */
var RedirectAttributesPaymentModeEnum;
(function (RedirectAttributesPaymentModeEnum) {
    RedirectAttributesPaymentModeEnum["FULLPAY"] = "FULLPAY";
    RedirectAttributesPaymentModeEnum["PAYONLY"] = "PAYONLY";
    RedirectAttributesPaymentModeEnum["PAYPLUS"] = "PAYPLUS";
})(RedirectAttributesPaymentModeEnum = exports.RedirectAttributesPaymentModeEnum || (exports.RedirectAttributesPaymentModeEnum = {}));
/**
    * @export
    * @enum {string}
    */
...
(function (Secure3D21AuthenticationRequestChallengeIndicatorEnum) {
    ...
    Secure3D21AuthenticationRequestChallengeIndicatorEnum["_05"] = "05";
    Secure3D21AuthenticationRequestChallengeIndicatorEnum["_06"] = "06";
    Secure3D21AuthenticationRequestChallengeIndicatorEnum["_07"] = "07";
    Secure3D21AuthenticationRequestChallengeIndicatorEnum["_08"] = "08";
    Secure3D21AuthenticationRequestChallengeIndicatorEnum["_09"] = "09";
...
/**
    ...
    * @enum {string}
    */
var Secure3D21AuthenticationRequestRequestorAuthenticationIndicatorEnum;
(function (Secure3D21AuthenticationRequestRequestorAuthenticationIndicatorEnum) {
    Secure3D21AuthenticationRequestRequestorAuthenticationIndicatorEnum["_01"] = "01";
    Secure3D21AuthenticationRequestRequestorAuthenticationIndicatorEnum["_02"] = "02";
    Secure3D21AuthenticationRequestRequestorAuthenticationIndicatorEnum["_03"] = "03";
    Secure3D21AuthenticationRequestRequestorAuthenticationIndicatorEnum["_04"] = "04";
    Secure3D21AuthenticationRequestRequestorAuthenticationIndicatorEnum["_05"] = "05";
    Secure3D21AuthenticationRequestRequestorAuthenticationIndicatorEnum["_06"] = "06";
})(Secure3D21AuthenticationRequestRequestorAuthenticationIndicatorEnum = exports.Secure3D21AuthenticationRequestRequestorAuthenticationIndicatorEnum || (exports.Secure3D21AuthenticationRequestRequestorAuthenticationIndicatorEnum = {}));
/**
    * @export
    * @enum {string}
    */
var Secure3D21AuthenticationRequestSecure3DDeviceChannelEnum;
(function (Secure3D21AuthenticationRequestSecure3DDeviceChannelEnum) {
    Secure3D21AuthenticationRequestSecure3DDeviceChannelEnum["_02"] = "02";
    Secure3D21AuthenticationRequestSecure3DDeviceChannelEnum["_03"] = "03";
})(Secure3D21AuthenticationRequestSecure3DDeviceChannelEnum = exports.Secure3D21AuthenticationRequestSecure3DDeviceChannelEnum || (exports.Secure3D21AuthenticationRequestSecure3DDeviceChannelEnum = {}));
/**
    * @export
    * @enum {string}
    */
var Secure3D21AuthenticationRequestSecure3DThreeRIIndicatorEnum;
(function (Secure3D21AuthenticationRequestSecure3DThreeRIIndicatorEnum) {
    Secure3D21AuthenticationRequestSecure3DThreeRIIndicatorEnum["_01"] = "01";
    Secure3D21AuthenticationRequestSecure3DThreeRIIndicatorEnum["_02"] = "02";
    Secure3D21AuthenticationRequestSecure3DThreeRIIndicatorEnum["_03"] = "03";
    Secure3D21AuthenticationRequestSecure3DThreeRIIndicatorEnum["_04"] = "04";
    Secure3D21AuthenticationRequestSecure3DThreeRIIndicatorEnum["_05"] = "05";
    Secure3D21AuthenticationRequestSecure3DThreeRIIndicatorEnum["_06"] = "06";
    Secure3D21AuthenticationRequestSecure3DThreeRIIndicatorEnum["_07"] = "07";
    Secure3D21AuthenticationRequestSecure3DThreeRIIndicatorEnum["_08"] = "08";
    Secure3D21AuthenticationRequestSecure3DThreeRIIndicatorEnum["_09"] = "09";
    Secure3D21AuthenticationRequestSecure3DThreeRIIndicatorEnum["_10"] = "10";
    Secure3D21AuthenticationRequestSecure3DThreeRIIndicatorEnum["_11"] = "11";
})(Secure3D21AuthenticationRequestSecure3DThreeRIIndicatorEnum = exports.Secure3D21AuthenticationRequestSecure3DThreeRIIndicatorEnum || (exports.Secure3D21AuthenticationRequestSecure3DThreeRIIndicatorEnum = {}));
/**
    * @export
    * @enum {string}
    */
...
(function (Secure3D21AuthenticationRequestAllOfChallengeIndicatorEnum) {
    ...
    Secure3D21AuthenticationRequestAllOfChallengeIndicatorEnum["_05"] = "05";
    Secure3D21AuthenticationRequestAllOfChallengeIndicatorEnum["_06"] = "06";
    Secure3D21AuthenticationRequestAllOfChallengeIndicatorEnum["_07"] = "07";
    Secure3D21AuthenticationRequestAllOfChallengeIndicatorEnum["_08"] = "08";
    Secure3D21AuthenticationRequestAllOfChallengeIndicatorEnum["_09"] = "09";
...
/**
    ...
    * @enum {string}
    */
var Secure3D21AuthenticationRequestAllOfRequestorAuthenticationIndicatorEnum;
(function (Secure3D21AuthenticationRequestAllOfRequestorAuthenticationIndicatorEnum) {
    Secure3D21AuthenticationRequestAllOfRequestorAuthenticationIndicatorEnum["_01"] = "01";
    Secure3D21AuthenticationRequestAllOfRequestorAuthenticationIndicatorEnum["_02"] = "02";
    Secure3D21AuthenticationRequestAllOfRequestorAuthenticationIndicatorEnum["_03"] = "03";
    Secure3D21AuthenticationRequestAllOfRequestorAuthenticationIndicatorEnum["_04"] = "04";
    Secure3D21AuthenticationRequestAllOfRequestorAuthenticationIndicatorEnum["_05"] = "05";
    Secure3D21AuthenticationRequestAllOfRequestorAuthenticationIndicatorEnum["_06"] = "06";
})(Secure3D21AuthenticationRequestAllOfRequestorAuthenticationIndicatorEnum = exports.Secure3D21AuthenticationRequestAllOfRequestorAuthenticationIndicatorEnum || (exports.Secure3D21AuthenticationRequestAllOfRequestorAuthenticationIndicatorEnum = {}));
/**
    * @export
    * @enum {string}
    */
var Secure3D21AuthenticationRequestAllOfSecure3DDeviceChannelEnum;
(function (Secure3D21AuthenticationRequestAllOfSecure3DDeviceChannelEnum) {
    Secure3D21AuthenticationRequestAllOfSecure3DDeviceChannelEnum["_02"] = "02";
    Secure3D21AuthenticationRequestAllOfSecure3DDeviceChannelEnum["_03"] = "03";
})(Secure3D21AuthenticationRequestAllOfSecure3DDeviceChannelEnum = exports.Secure3D21AuthenticationRequestAllOfSecure3DDeviceChannelEnum || (exports.Secure3D21AuthenticationRequestAllOfSecure3DDeviceChannelEnum = {}));
/**
    * @export
    * @enum {string}
    */
var Secure3D21AuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum;
(function (Secure3D21AuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum) {
    Secure3D21AuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum["_01"] = "01";
    Secure3D21AuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum["_02"] = "02";
    Secure3D21AuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum["_03"] = "03";
    Secure3D21AuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum["_04"] = "04";
    Secure3D21AuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum["_05"] = "05";
    Secure3D21AuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum["_06"] = "06";
    Secure3D21AuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum["_07"] = "07";
    Secure3D21AuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum["_08"] = "08";
    Secure3D21AuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum["_09"] = "09";
    Secure3D21AuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum["_10"] = "10";
    Secure3D21AuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum["_11"] = "11";
})(Secure3D21AuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum = exports.Secure3D21AuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum || (exports.Secure3D21AuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum = {}));
/**
    * @export
    * @enum {string}
    */
...
/**
    ...
    * @enum {string}
    */
var Secure3DAuthenticationRequestChallengeIndicatorEnum;
(function (Secure3DAuthenticationRequestChallengeIndicatorEnum) {
    Secure3DAuthenticationRequestChallengeIndicatorEnum["_01"] = "01";
    Secure3DAuthenticationRequestChallengeIndicatorEnum["_02"] = "02";
    Secure3DAuthenticationRequestChallengeIndicatorEnum["_03"] = "03";
    Secure3DAuthenticationRequestChallengeIndicatorEnum["_04"] = "04";
    Secure3DAuthenticationRequestChallengeIndicatorEnum["_05"] = "05";
    Secure3DAuthenticationRequestChallengeIndicatorEnum["_06"] = "06";
    Secure3DAuthenticationRequestChallengeIndicatorEnum["_07"] = "07";
    Secure3DAuthenticationRequestChallengeIndicatorEnum["_08"] = "08";
    Secure3DAuthenticationRequestChallengeIndicatorEnum["_09"] = "09";
})(Secure3DAuthenticationRequestChallengeIndicatorEnum = exports.Secure3DAuthenticationRequestChallengeIndicatorEnum || (exports.Secure3DAuthenticationRequestChallengeIndicatorEnum = {}));
/**
    * @export
    * @enum {string}
    */
var Secure3DAuthenticationRequestMessageCategoryEnum;
(function (Secure3DAuthenticationRequestMessageCategoryEnum) {
    Secure3DAuthenticationRequestMessageCategoryEnum["_01"] = "01";
    Secure3DAuthenticationRequestMessageCategoryEnum["_02"] = "02";
    Secure3DAuthenticationRequestMessageCategoryEnum["_80"] = "80";
})(Secure3DAuthenticationRequestMessageCategoryEnum = exports.Secure3DAuthenticationRequestMessageCategoryEnum || (exports.Secure3DAuthenticationRequestMessageCategoryEnum = {}));
/**
    * @export
    * @enum {string}
    */
var Secure3DAuthenticationRequestChallengeWindowSizeEnum;
(function (Secure3DAuthenticationRequestChallengeWindowSizeEnum) {
    Secure3DAuthenticationRequestChallengeWindowSizeEnum["_01"] = "01";
    Secure3DAuthenticationRequestChallengeWindowSizeEnum["_02"] = "02";
    Secure3DAuthenticationRequestChallengeWindowSizeEnum["_03"] = "03";
    Secure3DAuthenticationRequestChallengeWindowSizeEnum["_04"] = "04";
    Secure3DAuthenticationRequestChallengeWindowSizeEnum["_05"] = "05";
})(Secure3DAuthenticationRequestChallengeWindowSizeEnum = exports.Secure3DAuthenticationRequestChallengeWindowSizeEnum || (exports.Secure3DAuthenticationRequestChallengeWindowSizeEnum = {}));
/**
    * @export
    * @enum {string}
    */
var Secure3DAuthenticationRequestSecure3DDeviceChannelEnum;
(function (Secure3DAuthenticationRequestSecure3DDeviceChannelEnum) {
    Secure3DAuthenticationRequestSecure3DDeviceChannelEnum["_02"] = "02";
    Secure3DAuthenticationRequestSecure3DDeviceChannelEnum["_03"] = "03";
})(Secure3DAuthenticationRequestSecure3DDeviceChannelEnum = exports.Secure3DAuthenticationRequestSecure3DDeviceChannelEnum || (exports.Secure3DAuthenticationRequestSecure3DDeviceChannelEnum = {}));
/**
    * @export
    * @enum {string}
    */
var Secure3DAuthenticationRequestSecure3DThreeRIIndicatorEnum;
(function (Secure3DAuthenticationRequestSecure3DThreeRIIndicatorEnum) {
    Secure3DAuthenticationRequestSecure3DThreeRIIndicatorEnum["_01"] = "01";
    Secure3DAuthenticationRequestSecure3DThreeRIIndicatorEnum["_02"] = "02";
    Secure3DAuthenticationRequestSecure3DThreeRIIndicatorEnum["_03"] = "03";
    Secure3DAuthenticationRequestSecure3DThreeRIIndicatorEnum["_04"] = "04";
    Secure3DAuthenticationRequestSecure3DThreeRIIndicatorEnum["_05"] = "05";
    Secure3DAuthenticationRequestSecure3DThreeRIIndicatorEnum["_06"] = "06";
    Secure3DAuthenticationRequestSecure3DThreeRIIndicatorEnum["_07"] = "07";
    Secure3DAuthenticationRequestSecure3DThreeRIIndicatorEnum["_08"] = "08";
    Secure3DAuthenticationRequestSecure3DThreeRIIndicatorEnum["_09"] = "09";
    Secure3DAuthenticationRequestSecure3DThreeRIIndicatorEnum["_10"] = "10";
    Secure3DAuthenticationRequestSecure3DThreeRIIndicatorEnum["_11"] = "11";
})(Secure3DAuthenticationRequestSecure3DThreeRIIndicatorEnum = exports.Secure3DAuthenticationRequestSecure3DThreeRIIndicatorEnum || (exports.Secure3DAuthenticationRequestSecure3DThreeRIIndicatorEnum = {}));
/**
    * @export
    * @enum {string}
    */
var Secure3DAuthenticationRequestRequestorAuthenticationIndicatorEnum;
(function (Secure3DAuthenticationRequestRequestorAuthenticationIndicatorEnum) {
    Secure3DAuthenticationRequestRequestorAuthenticationIndicatorEnum["_01"] = "01";
    Secure3DAuthenticationRequestRequestorAuthenticationIndicatorEnum["_02"] = "02";
    Secure3DAuthenticationRequestRequestorAuthenticationIndicatorEnum["_03"] = "03";
    Secure3DAuthenticationRequestRequestorAuthenticationIndicatorEnum["_04"] = "04";
    Secure3DAuthenticationRequestRequestorAuthenticationIndicatorEnum["_05"] = "05";
    Secure3DAuthenticationRequestRequestorAuthenticationIndicatorEnum["_06"] = "06";
})(Secure3DAuthenticationRequestRequestorAuthenticationIndicatorEnum = exports.Secure3DAuthenticationRequestRequestorAuthenticationIndicatorEnum || (exports.Secure3DAuthenticationRequestRequestorAuthenticationIndicatorEnum = {}));
/**
    * @export
    * @enum {string}
    */
var Secure3DAuthenticationRequestAllOfChallengeIndicatorEnum;
(function (Secure3DAuthenticationRequestAllOfChallengeIndicatorEnum) {
    Secure3DAuthenticationRequestAllOfChallengeIndicatorEnum["_01"] = "01";
    Secure3DAuthenticationRequestAllOfChallengeIndicatorEnum["_02"] = "02";
    Secure3DAuthenticationRequestAllOfChallengeIndicatorEnum["_03"] = "03";
    Secure3DAuthenticationRequestAllOfChallengeIndicatorEnum["_04"] = "04";
    Secure3DAuthenticationRequestAllOfChallengeIndicatorEnum["_05"] = "05";
    Secure3DAuthenticationRequestAllOfChallengeIndicatorEnum["_06"] = "06";
    Secure3DAuthenticationRequestAllOfChallengeIndicatorEnum["_07"] = "07";
    Secure3DAuthenticationRequestAllOfChallengeIndicatorEnum["_08"] = "08";
    Secure3DAuthenticationRequestAllOfChallengeIndicatorEnum["_09"] = "09";
})(Secure3DAuthenticationRequestAllOfChallengeIndicatorEnum = exports.Secure3DAuthenticationRequestAllOfChallengeIndicatorEnum || (exports.Secure3DAuthenticationRequestAllOfChallengeIndicatorEnum = {}));
/**
    * @export
    * @enum {string}
    */
var Secure3DAuthenticationRequestAllOfMessageCategoryEnum;
(function (Secure3DAuthenticationRequestAllOfMessageCategoryEnum) {
    Secure3DAuthenticationRequestAllOfMessageCategoryEnum["_01"] = "01";
    Secure3DAuthenticationRequestAllOfMessageCategoryEnum["_02"] = "02";
    Secure3DAuthenticationRequestAllOfMessageCategoryEnum["_80"] = "80";
})(Secure3DAuthenticationRequestAllOfMessageCategoryEnum = exports.Secure3DAuthenticationRequestAllOfMessageCategoryEnum || (exports.Secure3DAuthenticationRequestAllOfMessageCategoryEnum = {}));
/**
    * @export
    * @enum {string}
    */
var Secure3DAuthenticationRequestAllOfChallengeWindowSizeEnum;
(function (Secure3DAuthenticationRequestAllOfChallengeWindowSizeEnum) {
    Secure3DAuthenticationRequestAllOfChallengeWindowSizeEnum["_01"] = "01";
    Secure3DAuthenticationRequestAllOfChallengeWindowSizeEnum["_02"] = "02";
    Secure3DAuthenticationRequestAllOfChallengeWindowSizeEnum["_03"] = "03";
    Secure3DAuthenticationRequestAllOfChallengeWindowSizeEnum["_04"] = "04";
    Secure3DAuthenticationRequestAllOfChallengeWindowSizeEnum["_05"] = "05";
})(Secure3DAuthenticationRequestAllOfChallengeWindowSizeEnum = exports.Secure3DAuthenticationRequestAllOfChallengeWindowSizeEnum || (exports.Secure3DAuthenticationRequestAllOfChallengeWindowSizeEnum = {}));
/**
    * @export
    * @enum {string}
    */
var Secure3DAuthenticationRequestAllOfSecure3DDeviceChannelEnum;
(function (Secure3DAuthenticationRequestAllOfSecure3DDeviceChannelEnum) {
    Secure3DAuthenticationRequestAllOfSecure3DDeviceChannelEnum["_02"] = "02";
    Secure3DAuthenticationRequestAllOfSecure3DDeviceChannelEnum["_03"] = "03";
})(Secure3DAuthenticationRequestAllOfSecure3DDeviceChannelEnum = exports.Secure3DAuthenticationRequestAllOfSecure3DDeviceChannelEnum || (exports.Secure3DAuthenticationRequestAllOfSecure3DDeviceChannelEnum = {}));
/**
    * @export
    * @enum {string}
    */
var Secure3DAuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum;
(function (Secure3DAuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum) {
    Secure3DAuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum["_01"] = "01";
    Secure3DAuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum["_02"] = "02";
    Secure3DAuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum["_03"] = "03";
    Secure3DAuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum["_04"] = "04";
    Secure3DAuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum["_05"] = "05";
    Secure3DAuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum["_06"] = "06";
    Secure3DAuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum["_07"] = "07";
    Secure3DAuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum["_08"] = "08";
    Secure3DAuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum["_09"] = "09";
    Secure3DAuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum["_10"] = "10";
    Secure3DAuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum["_11"] = "11";
})(Secure3DAuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum = exports.Secure3DAuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum || (exports.Secure3DAuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum = {}));
/**
    * @export
    * @enum {string}
    */
var Secure3DAuthenticationRequestAllOfRequestorAuthenticationIndicatorEnum;
(function (Secure3DAuthenticationRequestAllOfRequestorAuthenticationIndicatorEnum) {
    Secure3DAuthenticationRequestAllOfRequestorAuthenticationIndicatorEnum["_01"] = "01";
    Secure3DAuthenticationRequestAllOfRequestorAuthenticationIndicatorEnum["_02"] = "02";
    Secure3DAuthenticationRequestAllOfRequestorAuthenticationIndicatorEnum["_03"] = "03";
    Secure3DAuthenticationRequestAllOfRequestorAuthenticationIndicatorEnum["_04"] = "04";
    Secure3DAuthenticationRequestAllOfRequestorAuthenticationIndicatorEnum["_05"] = "05";
    Secure3DAuthenticationRequestAllOfRequestorAuthenticationIndicatorEnum["_06"] = "06";
})(Secure3DAuthenticationRequestAllOfRequestorAuthenticationIndicatorEnum = exports.Secure3DAuthenticationRequestAllOfRequestorAuthenticationIndicatorEnum || (exports.Secure3DAuthenticationRequestAllOfRequestorAuthenticationIndicatorEnum = {}));
/**
    * @export
    * @enum {string}
    */
...
/**
    ...
    * @enum {string}
    */
var Secure3DAuthenticationResultAuthenticationResponseEnum;
(function (Secure3DAuthenticationResultAuthenticationResponseEnum) {
    Secure3DAuthenticationResultAuthenticationResponseEnum["A"] = "A";
    Secure3DAuthenticationResultAuthenticationResponseEnum["N"] = "N";
    Secure3DAuthenticationResultAuthenticationResponseEnum["U"] = "U";
    Secure3DAuthenticationResultAuthenticationResponseEnum["Y"] = "Y";
    Secure3DAuthenticationResultAuthenticationResponseEnum["C"] = "C";
    Secure3DAuthenticationResultAuthenticationResponseEnum["R"] = "R";
})(Secure3DAuthenticationResultAuthenticationResponseEnum = exports.Secure3DAuthenticationResultAuthenticationResponseEnum || (exports.Secure3DAuthenticationResultAuthenticationResponseEnum = {}));
/**
    * @export
    * @enum {string}
    */
var Secure3DAuthenticationResultTransactionStatusEnum;
(function (Secure3DAuthenticationResultTransactionStatusEnum) {
    Secure3DAuthenticationResultTransactionStatusEnum["A"] = "A";
    Secure3DAuthenticationResultTransactionStatusEnum["N"] = "N";
    Secure3DAuthenticationResultTransactionStatusEnum["U"] = "U";
    Secure3DAuthenticationResultTransactionStatusEnum["Y"] = "Y";
    Secure3DAuthenticationResultTransactionStatusEnum["C"] = "C";
    Secure3DAuthenticationResultTransactionStatusEnum["R"] = "R";
})(Secure3DAuthenticationResultTransactionStatusEnum = exports.Secure3DAuthenticationResultTransactionStatusEnum || (exports.Secure3DAuthenticationResultTransactionStatusEnum = {}));
/**
    * @export
    * @enum {string}
    */
var Secure3DAuthenticationResultMessageCategoryEnum;
(function (Secure3DAuthenticationResultMessageCategoryEnum) {
    Secure3DAuthenticationResultMessageCategoryEnum["_01"] = "01";
    Secure3DAuthenticationResultMessageCategoryEnum["_02"] = "02";
    Secure3DAuthenticationResultMessageCategoryEnum["_80"] = "80";
})(Secure3DAuthenticationResultMessageCategoryEnum = exports.Secure3DAuthenticationResultMessageCategoryEnum || (exports.Secure3DAuthenticationResultMessageCategoryEnum = {}));
/**
    * @export
    * @enum {string}
    */
var Secure3DAuthenticationResultAllOfAuthenticationResponseEnum;
(function (Secure3DAuthenticationResultAllOfAuthenticationResponseEnum) {
    Secure3DAuthenticationResultAllOfAuthenticationResponseEnum["A"] = "A";
    Secure3DAuthenticationResultAllOfAuthenticationResponseEnum["N"] = "N";
    Secure3DAuthenticationResultAllOfAuthenticationResponseEnum["U"] = "U";
    Secure3DAuthenticationResultAllOfAuthenticationResponseEnum["Y"] = "Y";
    Secure3DAuthenticationResultAllOfAuthenticationResponseEnum["C"] = "C";
    Secure3DAuthenticationResultAllOfAuthenticationResponseEnum["R"] = "R";
})(Secure3DAuthenticationResultAllOfAuthenticationResponseEnum = exports.Secure3DAuthenticationResultAllOfAuthenticationResponseEnum || (exports.Secure3DAuthenticationResultAllOfAuthenticationResponseEnum = {}));
/**
    * @export
    * @enum {string}
    */
var Secure3DAuthenticationResultAllOfTransactionStatusEnum;
(function (Secure3DAuthenticationResultAllOfTransactionStatusEnum) {
    Secure3DAuthenticationResultAllOfTransactionStatusEnum["A"] = "A";
    Secure3DAuthenticationResultAllOfTransactionStatusEnum["N"] = "N";
    Secure3DAuthenticationResultAllOfTransactionStatusEnum["U"] = "U";
    Secure3DAuthenticationResultAllOfTransactionStatusEnum["Y"] = "Y";
    Secure3DAuthenticationResultAllOfTransactionStatusEnum["C"] = "C";
    Secure3DAuthenticationResultAllOfTransactionStatusEnum["R"] = "R";
})(Secure3DAuthenticationResultAllOfTransactionStatusEnum = exports.Secure3DAuthenticationResultAllOfTransactionStatusEnum || (exports.Secure3DAuthenticationResultAllOfTransactionStatusEnum = {}));
/**
    * @export
    * @enum {string}
    */
var Secure3DAuthenticationResultAllOfMessageCategoryEnum;
(function (Secure3DAuthenticationResultAllOfMessageCategoryEnum) {
    Secure3DAuthenticationResultAllOfMessageCategoryEnum["_01"] = "01";
    Secure3DAuthenticationResultAllOfMessageCategoryEnum["_02"] = "02";
    Secure3DAuthenticationResultAllOfMessageCategoryEnum["_80"] = "80";
})(Secure3DAuthenticationResultAllOfMessageCategoryEnum = exports.Secure3DAuthenticationResultAllOfMessageCategoryEnum || (exports.Secure3DAuthenticationResultAllOfMessageCategoryEnum = {}));
/**
    * @export
    * @enum {string}
    */
var Secure3DAuthenticationUpdateRequestMethodNotificationStatusEnum;
(function (Secure3DAuthenticationUpdateRequestMethodNotificationStatusEnum) {
    Secure3DAuthenticationUpdateRequestMethodNotificationStatusEnum["RECEIVED"] = "RECEIVED";
    Secure3DAuthenticationUpdateRequestMethodNotificationStatusEnum["EXPECTEDBUTNOTRECEIVED"] = "EXPECTED_BUT_NOT_RECEIVED";
    Secure3DAuthenticationUpdateRequestMethodNotificationStatusEnum["NOTEXPECTED"] = "NOT_EXPECTED";
})(Secure3DAuthenticationUpdateRequestMethodNotificationStatusEnum = exports.Secure3DAuthenticationUpdateRequestMethodNotificationStatusEnum || (exports.Secure3DAuthenticationUpdateRequestMethodNotificationStatusEnum = {}));
/**
    * @export
    * @enum {string}
    */
...
/**
    ...
    * @enum {string}
    */
var StandInDetailsStandInTypeEnum;
(function (StandInDetailsStandInTypeEnum) {
    StandInDetailsStandInTypeEnum["FIXEDAMOUNT"] = "FIXED_AMOUNT";
    StandInDetailsStandInTypeEnum["MAXIMUMAMOUNT"] = "MAXIMUM_AMOUNT";
})(StandInDetailsStandInTypeEnum = exports.StandInDetailsStandInTypeEnum || (exports.StandInDetailsStandInTypeEnum = {}));
/**
    * @export
    * @enum {string}
    */
var StandInDetailsFrequencyEnum;
(function (StandInDetailsFrequencyEnum) {
    StandInDetailsFrequencyEnum["WEEKLY"] = "WEEKLY";
    StandInDetailsFrequencyEnum["FORTNIGHTLY"] = "FORTNIGHTLY";
    StandInDetailsFrequencyEnum["MONTHLY"] = "MONTHLY";
    StandInDetailsFrequencyEnum["QUARTERLY"] = "QUARTERLY";
    StandInDetailsFrequencyEnum["HALFYEARLY"] = "HALFYEARLY";
    StandInDetailsFrequencyEnum["YEARLY"] = "YEARLY";
    StandInDetailsFrequencyEnum["UNSCHEDULED"] = "UNSCHEDULED";
})(StandInDetailsFrequencyEnum = exports.StandInDetailsFrequencyEnum || (exports.StandInDetailsFrequencyEnum = {}));
/**
    * @export
    * @enum {string}
    */
...
(function (TransactionErrorResponseTransactionStatusEnum) {
    ...
    TransactionErrorResponseTransactionStatusEnum["PARTIAL"] = "PARTIAL";
...
(function (TransactionResponseTransactionStatusEnum) {
    ...
    TransactionResponseTransactionStatusEnum["PARTIAL"] = "PARTIAL";
...
exports.OrderApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @param {number} timestamp Epoch timestamp in milliseconds in the request from a client system. Used for Message Signature generation and time limit (5 mins).
         * @param {string} orderId Gateway order identifier as returned in the parameter orderId.
         * @param {SecondaryTransaction} secondaryTransaction Accepted request types: PostAuthTransaction, VoidTransaction, VoidPreAuthTransactions, ReturnTransaction, AchPostAuthTransaction, AchVoidTransaction, AchReturnTransaction and PreAuthSecondaryTransaction.
         * @param {string} [messageSignature] Used to ensure the request has not been tampered with during transmission. The Message-Signature is the Base64 encoded HMAC hash (SHA256 algorithm with the API Secret as the key.) For more information, refer to the supporting documentation on the Developer Portal.
         * @param {string} [region] Indicates the region where the client wants the transaction to be processed. This will override the default processing region identified for the client. Available options are argentina, brazil, germany, india and northamerica. Region specific store setup and APIGEE boarding is required in order to use an alternate region for processing.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
...
exports.PaymentApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @param {AuthenticationUpdateRequest} authenticationUpdateRequest Accepted request types: Secure3DAuthenticationUpdateRequest, Secure3D10AuthenticationUpdateRequest, Secure3D21AuthenticationUpdateRequest and UnionPayAuthenticationUpdateRequest.
         * @param {string} [messageSignature] Used to ensure the request has not been tampered with during transmission. The Message-Signature is the Base64 encoded HMAC hash (SHA256 algorithm with the API Secret as the key.) For more information, refer to the supporting documentation on the Developer Portal.
         * @param {string} [region] Indicates the region where the client wants the transaction to be processed. This will override the default processing region identified for the client. Available options are argentina, brazil, germany, india and northamerica. Region specific store setup and APIGEE boarding is required in order to use an alternate region for processing.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
