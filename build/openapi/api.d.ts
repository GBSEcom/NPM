...
/**
    ...
    * @enum {string}
    */
export declare enum AdditionalDetailsScaExemptionTypeEnum {
...
/**
    ...
    * @enum {string}
    */
export declare enum AdditionalDetailsBusinessApplicationIdentifierEnum {
...
export interface ApmPaymentMethod {
     ...
     * @type {Array<PaymentStepResponse>}
     * @memberof ApmPaymentMethod
     */
    steps?: Array<PaymentStepResponse>;
}
/**
 *
 * @export
...
/**
    ...
    * @enum {string}
    */
export declare enum BasketProductStockEnum {
    Check = "check"
}
/**
 * Item details.
 ...
 * @export
 * @interface GenericManagedRedirectRequest
 */
export interface GenericManagedRedirectRequest extends ManagedRedirectPrimaryRequest {
    /**
     *
     * @type {ManagedRedirectPaymentMethod}
     * @memberof GenericManagedRedirectRequest
     */
    paymentMethod?: ManagedRedirectPaymentMethod;
}
/**
 *
 * @export
 * @interface GenericManagedRedirectRequestAllOf
 */
export interface GenericManagedRedirectRequestAllOf {
    /**
     *
     * @type {ManagedRedirectPaymentMethod}
     * @memberof GenericManagedRedirectRequestAllOf
     */
    paymentMethod?: ManagedRedirectPaymentMethod;
}
/**
...
/**
 * Request further integration details, e.g. providing the payer\'s IP address.
 * @export
 * @interface IntegrationStepRequest
 */
export interface IntegrationStepRequest extends StepRequest {
}
/**
 * Response to a integration step request
 * @export
 * @interface IntegrationStepResponse
 */
export interface IntegrationStepResponse extends StepResponse {
}
/**
 ...
 * @export
 * @interface ManagedRedirectPaymentMethod
 */
export interface ManagedRedirectPaymentMethod {
    /**
     * Payment Method Type Enum
     * @type {string}
     * @memberof ManagedRedirectPaymentMethod
     */
    paymentMethodType?: ManagedRedirectPaymentMethodPaymentMethodTypeEnum;
}
/**
    * @export
    * @enum {string}
    */
export declare enum ManagedRedirectPaymentMethodPaymentMethodTypeEnum {
    GIROPAY = "GIROPAY",
    IDEAL = "IDEAL",
    KLARNA = "KLARNA",
    KPS = "KPS",
    PAYPAL = "PAYPAL",
    SBPSOTHERPAYMENTS = "SBPS_OTHER_PAYMENTS",
    SOFORT = "SOFORT"
}
/**
 * Request to generate an embedded payment link for Managed redirect.
 * @export
 * @interface ManagedRedirectPrimaryRequest
 */
export interface ManagedRedirectPrimaryRequest {
    /**
     * Object name of the primary transaction request.
     * @type {string}
     * @memberof ManagedRedirectPrimaryRequest
     */
    requestType: string;
    /**
     *
     ...
     * @memberof ManagedRedirectPrimaryRequest
     */
    transactionType?: ManagedRedirectTransactionType;
    /**
     *
     * @type {Order}
     * @memberof ManagedRedirectPrimaryRequest
 ...
 * @export
 * @interface ManagedRedirectResponse
 */
export interface ManagedRedirectResponse {
    /**
     * Echoes back the value in the request header for tracking.
     * @type {string}
     * @memberof ManagedRedirectResponse
     */
    clientRequestId?: string;
    /**
     * Request identifier in API, can be used to request logs from the support team.
     ...
     * @memberof ManagedRedirectResponse
     */
    requestStatus?: ManagedRedirectResponseRequestStatusEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export declare enum ManagedRedirectResponseRequestStatusEnum {
    SUCCESS = "SUCCESS",
 ...
 * @enum {string}
 */
export declare enum ManagedRedirectTransactionType {
    SALE = "SALE",
    PREAUTH = "PREAUTH",
 ...
 * @export
 * @interface PaymentBrandResponse
 */
export interface PaymentBrandResponse {
    /**
     * Echoes back the value in the request header for tracking.
     * @type {string}
     * @memberof PaymentBrandResponse
     */
    clientRequestId?: string;
    /**
     * Request identifier in API, can be used to request logs from the support team.
 ...
 *
 * @export
 * @interface PaymentCardCreditTransactionAllOf
 */
export interface PaymentCardCreditTransactionAllOf {
    /**
     *
     * @type {PaymentCardPaymentMethod}
     * @memberof PaymentCardCreditTransactionAllOf
     */
    paymentMethod: PaymentCardPaymentMethod;
    /**
     *
 ...
 * Request to create Managed Redirect sale transaction using payment card.
 * @export
 * @interface PaymentCardManagedRedirectRequest
 */
export interface PaymentCardManagedRedirectRequest extends ManagedRedirectPrimaryRequest {
    /**
     *
     * @type {PaymentCardPaymentMethod}
     * @memberof PaymentCardManagedRedirectRequest
     */
    paymentMethod?: PaymentCardPaymentMethod;
}
/**
 *
 * @export
 * @interface PaymentCardManagedRedirectRequestAllOf
 */
export interface PaymentCardManagedRedirectRequestAllOf {
    /**
     *
     * @type {PaymentCardPaymentMethod}
     * @memberof PaymentCardManagedRedirectRequestAllOf
     */
    paymentMethod?: PaymentCardPaymentMethod;
}
/**
...
/**
 * Request a step from the payer or merchant, e.g. providing information.
 * @export
 * @interface PaymentStepRequest
 */
export interface PaymentStepRequest extends StepRequest {
}
/**
 * Response to a payment step request
 * @export
 * @interface PaymentStepResponse
 */
export interface PaymentStepResponse extends StepResponse {
}
/**
 ...
 * @export
 * @interface PreAuthSecondaryTransaction
 */
export interface PreAuthSecondaryTransaction extends SecondaryTransaction {
    /**
     *
     * @type {Amount}
     * @memberof PreAuthSecondaryTransaction
     */
    transactionAmount: Amount;
    /**
     * This flag can only be used in a preAuth transaction that updates the amount of a previous preAuth transaction to either increase the preAuth amount (DecrementalPreAuthFlag = false) or decrease the preAuth amount (DecrementalPreAuthFlag = true).
 ...
 *
 * @export
 * @interface PreAuthSecondaryTransactionAllOf
 */
export interface PreAuthSecondaryTransactionAllOf {
    /**
     *
     * @type {Amount}
     * @memberof PreAuthSecondaryTransactionAllOf
     */
    transactionAmount: Amount;
    /**
     * This flag can only be used in a preAuth transaction that updates the amount of a previous preAuth transaction to either increase the preAuth amount (DecrementalPreAuthFlag = false) or decrease the preAuth amount (DecrementalPreAuthFlag = true).
 ...
 * @export
 * @interface ProvideDetailIntegrationStepRequest
 */
export interface ProvideDetailIntegrationStepRequest {
    /**
     *
     * @type {string}
     * @memberof ProvideDetailIntegrationStepRequest
     */
    type: string;
    /**
     *
 ...
 *
 * @export
 * @interface ProvideDetailIntegrationStepRequestAllOf
 */
export interface ProvideDetailIntegrationStepRequestAllOf {
    /**
     *
     * @type {string}
     * @memberof ProvideDetailIntegrationStepRequestAllOf
     */
    key?: string;
}
/**
 ...
 * @export
 * @interface ProvideDetailIntegrationStepResponse
 */
export interface ProvideDetailIntegrationStepResponse {
    /**
     *
     * @type {string}
     * @memberof ProvideDetailIntegrationStepResponse
     */
    type: string;
    /**
 ...
 *
 * @export
 * @interface ProvideDetailIntegrationStepResponseAllOf
 */
export interface ProvideDetailIntegrationStepResponseAllOf {
    /**
     * MerchantIdentifier of the provided detail.
     * @type {string}
     * @memberof ProvideDetailIntegrationStepResponseAllOf
     */
    detailKey?: string;
    /**
     * Integration value provided by merchant during integration
 ...
 * Request to inquire information from the payer or merchant.
 * @export
 * @interface ProvideDetailPaymentStepRequest
 */
export interface ProvideDetailPaymentStepRequest {
    /**
     *
     * @type {string}
     * @memberof ProvideDetailPaymentStepRequest
     */
    type: string;
    /**
     *
 ...
 *
 * @export
 * @interface ProvideDetailPaymentStepRequestAllOf
 */
export interface ProvideDetailPaymentStepRequestAllOf {
    /**
     *
     * @type {string}
     * @memberof ProvideDetailPaymentStepRequestAllOf
     */
    hint?: string;
    /**
     *
 ...
 * @export
 * @interface ProvideDetailPaymentStepResponse
 */
export interface ProvideDetailPaymentStepResponse {
    /**
     *
     * @type {string}
     * @memberof ProvideDetailPaymentStepResponse
     */
    type: string;
    /**
     * MerchantIdentifier of the provided detail.
 ...
 *
 * @export
 * @interface ProvideDetailPaymentStepResponseAllOf
 */
export interface ProvideDetailPaymentStepResponseAllOf {
    /**
     * MerchantIdentifier of the provided detail.
     * @type {string}
     * @memberof ProvideDetailPaymentStepResponseAllOf
     */
    detailKey?: string;
    /**
     * Value provided by the payer or merchant, validated by JavaScript regular expression
...
export interface PurchaseCardsLevel2 {
     ...
     * @memberof PurchaseCardsLevel2
     */
    dutyAmountAndRate?: AdditionalAmountRate;
}
/**
...
export interface Receipt {
     ...
     * @type {Array<ReceiptLine>}
     * @memberof Receipt
     */
    data: Array<ReceiptLine>;
}
/**
    * @export
    * @enum {string}
...
/**
    ...
    * @enum {string}
    */
export declare enum ReceiptRequestInfoTypeEnum {
    Cardholder = "cardholder",
    Merchant = "merchant"
}
/**
...
export interface RedirectAttributes {
     ...
     * @type {string}
     * @memberof RedirectAttributes
     */
    challengeIndicator?: RedirectAttributesChallengeIndicatorEnum;
    /**
     * If 3D secure should be applied.
     * @type {boolean}
     * @memberof RedirectAttributes
     ...
     * @memberof RedirectAttributes
     */
    threeDSEmvCoMessageCategory?: RedirectAttributesThreeDSEmvCoMessageCategoryEnum;
    /**
     ...
     * @memberof RedirectAttributes
     */
    override3dsCountryExclusion?: boolean;
    /**
     * Secure 3D Transaction Type
     * @type {string}
     * @memberof RedirectAttributes
     */
    threeDSTransactionType?: RedirectAttributesThreeDSTransactionTypeEnum;
    /**
     ...
     * @memberof RedirectAttributes
     */
    paymentMode?: RedirectAttributesPaymentModeEnum;
    /**
     * Language used by client.
     * @type {string}
     * @memberof RedirectAttributes
...
/**
    ...
    * @enum {string}
    */
export declare enum RedirectAttributesChallengeIndicatorEnum {
    _01 = "01",
    _02 = "02",
    _03 = "03",
    _04 = "04"
...
/**
    ...
    * @enum {string}
    */
export declare enum RedirectAttributesThreeDSEmvCoMessageCategoryEnum {
    _01 = "01",
    _02 = "02",
    _80 = "80"
}
/**
    ...
    * @enum {string}
    */
export declare enum RedirectAttributesThreeDSTransactionTypeEnum {
    _01 = "01",
    _03 = "03",
    _10 = "10",
    _11 = "11",
...
/**
    ...
    * @enum {string}
    */
export declare enum RedirectAttributesPaymentModeEnum {
    FULLPAY = "FULLPAY",
    PAYONLY = "PAYONLY",
    PAYPLUS = "PAYPLUS"
}
...
export interface Secure3D21AuthenticationRequest extends AuthenticationRequest {
     ...
     * @memberof Secure3D21AuthenticationRequest
     */
    authenticationIndicator?: Secure3D21AuthenticationRequestAuthenticationIndicatorEnum;
    /**
     * 02 = BRW 03 = 3RI
     * @type {string}
     * @memberof Secure3D21AuthenticationRequest
     */
    secure3DDeviceChannel?: Secure3D21AuthenticationRequestSecure3DDeviceChannelEnum;
    /**
     ...
     * @memberof Secure3D21AuthenticationRequest
     */
    secure3DThreeRIIndicator?: Secure3D21AuthenticationRequestSecure3DThreeRIIndicatorEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export declare enum Secure3D21AuthenticationRequestAuthenticationIndicatorEnum {
    _01 = "01",
    _02 = "02",
    _03 = "03",
    _04 = "04",
...
/**
    ...
    * @enum {string}
    */
export declare enum Secure3D21AuthenticationRequestSecure3DDeviceChannelEnum {
    _02 = "02",
    _03 = "03"
}
/**
    ...
    * @enum {string}
    */
export declare enum Secure3D21AuthenticationRequestSecure3DThreeRIIndicatorEnum {
    _01 = "01",
    _02 = "02",
    _03 = "03",
    _04 = "04",
...
export interface Secure3D21AuthenticationRequestAllOf {
     ...
     * @memberof Secure3D21AuthenticationRequestAllOf
     */
    authenticationIndicator?: Secure3D21AuthenticationRequestAllOfAuthenticationIndicatorEnum;
    /**
     * 02 = BRW 03 = 3RI
     * @type {string}
     * @memberof Secure3D21AuthenticationRequestAllOf
     */
    secure3DDeviceChannel?: Secure3D21AuthenticationRequestAllOfSecure3DDeviceChannelEnum;
    /**
     * 01 = Recurring transaction 02 = Instalment transaction 03 = Add card 04 = Maintain card information 05 = Account verification 06 = Split/delayed shipment 07 = Top-up 08 = Mail Order 09 = Telephone Order 10 = Whitelist status check 11 = Other payment
     * @type {string}
     * @memberof Secure3D21AuthenticationRequestAllOf
     */
    secure3DThreeRIIndicator?: Secure3D21AuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum;
    /**
     * Date after which no further authorisations shall be performed.
     * @type {string}
     * @memberof Secure3D21AuthenticationRequestAllOf
...
/**
    ...
    * @enum {string}
    */
export declare enum Secure3D21AuthenticationRequestAllOfAuthenticationIndicatorEnum {
    _01 = "01",
    _02 = "02",
    _03 = "03",
    _04 = "04",
...
/**
    ...
    * @enum {string}
    */
export declare enum Secure3D21AuthenticationRequestAllOfSecure3DDeviceChannelEnum {
    _02 = "02",
    _03 = "03"
}
/**
    ...
    * @enum {string}
    */
export declare enum Secure3D21AuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum {
    _01 = "01",
    _02 = "02",
    _03 = "03",
    _04 = "04",
 ...
 */
export interface Secure3DAuthenticationRequest extends AuthenticationRequest {
    /**
     * The result of the authentication will be sent to this URL. If not provided, a term URL will be dynamically generated. Note this must be a valid URL (special characters should be URL-encoded).
     * @type {string}
     * @memberof Secure3DAuthenticationRequest
     */
    termURL: string;
    /**
     * The 3DS method iframe and transaction ID will be sent here. Note this must be a valid URL (special characters should be URL-encoded).
     ...
     * @memberof Secure3DAuthenticationRequest
     */
    challengeIndicator?: Secure3DAuthenticationRequestChallengeIndicatorEnum;
    /**
     ...
     * @memberof Secure3DAuthenticationRequest
     */
    messageCategory?: Secure3DAuthenticationRequestMessageCategoryEnum;
    /**
     * Defines the size of the challenge window displayed to customers during authentication. 01 = 250 x 400 02 = 390 x 400 03 = 500 x 600 04 = 600 x 400 05 = Full screen
     * @type {string}
     * @memberof Secure3DAuthenticationRequest
     */
    challengeWindowSize?: Secure3DAuthenticationRequestChallengeWindowSizeEnum;
    /**
     * Indicates if the browser issuing the request is capable of performing JavaScript.
     * @type {boolean}
     * @memberof Secure3DAuthenticationRequest
     ...
     * @memberof Secure3DAuthenticationRequest
     */
    secure3DDeviceChannel?: Secure3DAuthenticationRequestSecure3DDeviceChannelEnum;
    /**
     * 01 = Recurring transaction 02 = Instalment transaction 03 = Add card 04 = Maintain card information 05 = Account verification 06 = Split/delayed shipment 07 = Top-up 08 = Mail Order 09 = Telephone Order 10 = Whitelist status check 11 = Other payment
     * @type {string}
     * @memberof Secure3DAuthenticationRequest
     */
    secure3DThreeRIIndicator?: Secure3DAuthenticationRequestSecure3DThreeRIIndicatorEnum;
    /**
     * Provides additional information to the ACS to determine the best approach for handling an authentication request. 01 = Payment transaction 02 = Recurring transaction 03 = Installment transaction 04 = Add card 05 = Maintain card 06 = Card holder verification as part of EMV token ID and Value
     * @type {string}
     * @memberof Secure3DAuthenticationRequest
     */
    authenticationIndicator?: Secure3DAuthenticationRequestAuthenticationIndicatorEnum;
    /**
     * Date after which no further authorisations shall be performed.
     * @type {string}
     * @memberof Secure3DAuthenticationRequest
...
/**
    ...
    * @enum {string}
    */
export declare enum Secure3DAuthenticationRequestChallengeIndicatorEnum {
    _01 = "01",
    _02 = "02",
    _03 = "03",
    _04 = "04",
...
/**
    ...
    * @enum {string}
    */
export declare enum Secure3DAuthenticationRequestMessageCategoryEnum {
    _01 = "01",
    _02 = "02",
    _80 = "80"
}
/**
    ...
    * @enum {string}
    */
export declare enum Secure3DAuthenticationRequestChallengeWindowSizeEnum {
    _01 = "01",
    _02 = "02",
    _03 = "03",
    _04 = "04",
...
/**
    ...
    * @enum {string}
    */
export declare enum Secure3DAuthenticationRequestSecure3DDeviceChannelEnum {
    _02 = "02",
    _03 = "03"
}
/**
    ...
    * @enum {string}
    */
export declare enum Secure3DAuthenticationRequestSecure3DThreeRIIndicatorEnum {
    _01 = "01",
    _02 = "02",
    _03 = "03",
    _04 = "04",
...
/**
    ...
    * @enum {string}
    */
export declare enum Secure3DAuthenticationRequestAuthenticationIndicatorEnum {
    _01 = "01",
    _02 = "02",
    _03 = "03",
    _04 = "04",
 ...
 *
 * @export
 * @interface Secure3DAuthenticationRequestAllOf
 */
export interface Secure3DAuthenticationRequestAllOf {
    /**
     * The result of the authentication will be sent to this URL. If not provided, a term URL will be dynamically generated. Note this must be a valid URL (special characters should be URL-encoded).
     * @type {string}
     * @memberof Secure3DAuthenticationRequestAllOf
     */
    termURL: string;
    /**
     * The 3DS method iframe and transaction ID will be sent here. Note this must be a valid URL (special characters should be URL-encoded).
     ...
     * @memberof Secure3DAuthenticationRequestAllOf
     */
    challengeIndicator?: Secure3DAuthenticationRequestAllOfChallengeIndicatorEnum;
    /**
     * Indicates the message category of 3d secure authentication version 2.X. 01 = Payment Authentication 02 = Non-Payment Authentication 80 = Mastercard Data Only
     * @type {string}
     * @memberof Secure3DAuthenticationRequestAllOf
     */
    messageCategory?: Secure3DAuthenticationRequestAllOfMessageCategoryEnum;
    /**
     * Defines the size of the challenge window displayed to customers during authentication. 01 = 250 x 400 02 = 390 x 400 03 = 500 x 600 04 = 600 x 400 05 = Full screen
     * @type {string}
     * @memberof Secure3DAuthenticationRequestAllOf
     */
    challengeWindowSize?: Secure3DAuthenticationRequestAllOfChallengeWindowSizeEnum;
    /**
     * Indicates if the browser issuing the request is capable of performing JavaScript.
     * @type {boolean}
     * @memberof Secure3DAuthenticationRequestAllOf
     ...
     * @memberof Secure3DAuthenticationRequestAllOf
     */
    secure3DDeviceChannel?: Secure3DAuthenticationRequestAllOfSecure3DDeviceChannelEnum;
    /**
     * 01 = Recurring transaction 02 = Instalment transaction 03 = Add card 04 = Maintain card information 05 = Account verification 06 = Split/delayed shipment 07 = Top-up 08 = Mail Order 09 = Telephone Order 10 = Whitelist status check 11 = Other payment
     * @type {string}
     * @memberof Secure3DAuthenticationRequestAllOf
     */
    secure3DThreeRIIndicator?: Secure3DAuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum;
    /**
     * Provides additional information to the ACS to determine the best approach for handling an authentication request. 01 = Payment transaction 02 = Recurring transaction 03 = Installment transaction 04 = Add card 05 = Maintain card 06 = Card holder verification as part of EMV token ID and Value
     * @type {string}
     * @memberof Secure3DAuthenticationRequestAllOf
     */
    authenticationIndicator?: Secure3DAuthenticationRequestAllOfAuthenticationIndicatorEnum;
    /**
     * Date after which no further authorisations shall be performed.
     * @type {string}
     * @memberof Secure3DAuthenticationRequestAllOf
...
/**
    ...
    * @enum {string}
    */
export declare enum Secure3DAuthenticationRequestAllOfChallengeIndicatorEnum {
    _01 = "01",
    _02 = "02",
    _03 = "03",
    _04 = "04",
...
/**
    ...
    * @enum {string}
    */
export declare enum Secure3DAuthenticationRequestAllOfMessageCategoryEnum {
    _01 = "01",
    _02 = "02",
    _80 = "80"
}
/**
    ...
    * @enum {string}
    */
export declare enum Secure3DAuthenticationRequestAllOfChallengeWindowSizeEnum {
    _01 = "01",
    _02 = "02",
    _03 = "03",
    _04 = "04",
...
/**
    ...
    * @enum {string}
    */
export declare enum Secure3DAuthenticationRequestAllOfSecure3DDeviceChannelEnum {
    _02 = "02",
    _03 = "03"
}
/**
    ...
    * @enum {string}
    */
export declare enum Secure3DAuthenticationRequestAllOfSecure3DThreeRIIndicatorEnum {
    _01 = "01",
    _02 = "02",
    _03 = "03",
    _04 = "04",
...
/**
    ...
    * @enum {string}
    */
export declare enum Secure3DAuthenticationRequestAllOfAuthenticationIndicatorEnum {
    _01 = "01",
    _02 = "02",
    _03 = "03",
    _04 = "04",
 ...
 */
export interface Secure3DAuthenticationResult extends AuthenticationResult {
    /**
     * The Cardholder Authentication Verification Value (CAVV) is a cryptographic value derived by the issuer during payment authentication that can provide evidence of the results of payment authentication during an online purchase.
     * @type {string}
     ...
     * @memberof Secure3DAuthenticationResult
     */
    authenticationResponse?: Secure3DAuthenticationResultAuthenticationResponseEnum;
    /**
     * The transaction status as returned by the 3D Secure authentication process. (CRes)
     * @type {string}
     * @memberof Secure3DAuthenticationResult
     */
    transactionStatus?: Secure3DAuthenticationResultTransactionStatusEnum;
    /**
     * Indicates the message category of 3d secure authentication version 2.X. 01 = Payment Authentication 02 = Non-Payment Authentication 80 = Mastercard Data Only
     * @type {string}
     * @memberof Secure3DAuthenticationResult
     */
    messageCategory?: Secure3DAuthenticationResultMessageCategoryEnum;
}
/**
    * @export
    * @enum {string}
    */
export declare enum Secure3DAuthenticationResultAuthenticationResponseEnum {
    A = "A",
    N = "N",
    U = "U",
    Y = "Y",
...
/**
    ...
    * @enum {string}
    */
export declare enum Secure3DAuthenticationResultTransactionStatusEnum {
    A = "A",
    N = "N",
    U = "U",
    Y = "Y",
...
/**
    ...
    * @enum {string}
    */
export declare enum Secure3DAuthenticationResultMessageCategoryEnum {
    _01 = "01",
    _02 = "02",
    _80 = "80"
}
 ...
 *
 * @export
 * @interface Secure3DAuthenticationResultAllOf
 */
export interface Secure3DAuthenticationResultAllOf {
    /**
     * The Cardholder Authentication Verification Value (CAVV) is a cryptographic value derived by the issuer during payment authentication that can provide evidence of the results of payment authentication during an online purchase.
     * @type {string}
     * @memberof Secure3DAuthenticationResultAllOf
     */
    cavv?: string;
    /**
     * The transaction identifier (XID) is a unique tracking number set by the merchant.
     ...
     * @memberof Secure3DAuthenticationResultAllOf
     */
    authenticationResponse?: Secure3DAuthenticationResultAllOfAuthenticationResponseEnum;
    /**
     * The transaction status as returned by the 3D Secure authentication process. (CRes)
     * @type {string}
     * @memberof Secure3DAuthenticationResultAllOf
     */
    transactionStatus?: Secure3DAuthenticationResultAllOfTransactionStatusEnum;
    /**
     * Indicates the message category of 3d secure authentication version 2.X. 01 = Payment Authentication 02 = Non-Payment Authentication 80 = Mastercard Data Only
     * @type {string}
     * @memberof Secure3DAuthenticationResultAllOf
     */
    messageCategory?: Secure3DAuthenticationResultAllOfMessageCategoryEnum;
}
/**
    * @export
    * @enum {string}
    */
export declare enum Secure3DAuthenticationResultAllOfAuthenticationResponseEnum {
    A = "A",
    N = "N",
    U = "U",
    Y = "Y",
...
/**
    ...
    * @enum {string}
    */
export declare enum Secure3DAuthenticationResultAllOfTransactionStatusEnum {
    A = "A",
    N = "N",
    U = "U",
    Y = "Y",
...
/**
    ...
    * @enum {string}
    */
export declare enum Secure3DAuthenticationResultAllOfMessageCategoryEnum {
    _01 = "01",
    _02 = "02",
    _80 = "80"
}
 ...
 * @export
 * @interface Secure3DAuthenticationUpdateRequest
 */
export interface Secure3DAuthenticationUpdateRequest extends AuthenticationUpdateRequest {
    /**
     * Indicates how the merchant received the 3DS method.
     * @type {string}
     * @memberof Secure3DAuthenticationUpdateRequest
     */
    methodNotificationStatus?: Secure3DAuthenticationUpdateRequestMethodNotificationStatusEnum;
    /**
     *
     * @type {ACSResponse}
     * @memberof Secure3DAuthenticationUpdateRequest
...
/**
    ...
    * @enum {string}
    */
export declare enum Secure3DAuthenticationUpdateRequestMethodNotificationStatusEnum {
    RECEIVED = "RECEIVED",
    EXPECTEDBUTNOTRECEIVED = "EXPECTED_BUT_NOT_RECEIVED",
    NOTEXPECTED = "NOT_EXPECTED"
}
 ...
 * @export
 * @interface SepaCreditPaymentMethod
 */
export interface SepaCreditPaymentMethod {
    /**
     *
     * @type {SepaCredit}
     * @memberof SepaCreditPaymentMethod
     */
    sepa: SepaCredit;
}
/**
 *
 * @export
 * @interface SepaCreditPaymentMethodAllOf
 */
export interface SepaCreditPaymentMethodAllOf {
    /**
     *
     * @type {SepaCredit}
     * @memberof SepaCreditPaymentMethodAllOf
     */
    sepa: SepaCredit;
}
/**
 ...
 */
export interface SepaCreditTransaction extends PrimaryTransaction {
    /**
     *
     * @type {SepaCreditPaymentMethod}
     * @memberof SepaCreditTransaction
     */
    paymentMethod: SepaCreditPaymentMethod;
}
/**
 *
 * @export
 * @interface SepaCreditTransactionAllOf
 */
export interface SepaCreditTransactionAllOf {
    /**
     *
     * @type {SepaCreditPaymentMethod}
     * @memberof SepaCreditTransactionAllOf
     */
    paymentMethod: SepaCreditPaymentMethod;
}
/**
 ...
 * @export
 * @interface SepaSalePaymentMethod
 */
export interface SepaSalePaymentMethod {
    /**
     *
     * @type {SepaSale}
     * @memberof SepaSalePaymentMethod
     */
    sepa: SepaSale;
}
/**
 *
 * @export
 * @interface SepaSalePaymentMethodAllOf
 */
export interface SepaSalePaymentMethodAllOf {
    /**
     *
     * @type {SepaSale}
     * @memberof SepaSalePaymentMethodAllOf
     */
    sepa: SepaSale;
}
/**
...
export interface SepaSaleTransaction extends PrimaryTransaction {
     ...
     */
    paymentMethod: SepaSalePaymentMethod;
}
/**
 *
 * @export
 ...
 * @export
 * @interface StandInDetails
 */
export interface StandInDetails {
    /**
     * Indicates standin instruction type.
     * @type {string}
     * @memberof StandInDetails
     */
    standInType: StandInDetailsStandInTypeEnum;
    /**
     ...
     * @memberof StandInDetails
     */
    frequency: StandInDetailsFrequencyEnum;
}
/**
    * @export
    * @enum {string}
    */
export declare enum StandInDetailsStandInTypeEnum {
...
/**
    ...
    * @enum {string}
    */
export declare enum StandInDetailsFrequencyEnum {
    WEEKLY = "WEEKLY",
 ...
 * @export
 * @interface StandinResponseDetails
 */
export interface StandinResponseDetails {
    /**
     * Secure 3D Enrolment Status.
     * @type {string}
     * @memberof StandinResponseDetails
     */
...
/**
 * Consumer billing address details.|+For Telecheck Verification service: *Required for U.S Addresses.|+For Telecheck Warrant service: *Required.|+For help with Telecheck Services, please contact your Fiserv Telecheck Sales Representative.
 * @export
...
export declare const AuthenticationApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
     ...
     */
    authenticationAccessTokensPost(contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, accessTokenRequest: AccessTokenRequest, messageSignature?: string | undefined, options?: any): RequestArgs;
};
/**
...
export declare const AuthenticationApiFp: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    authenticationAccessTokensPost(contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, accessTokenRequest: AccessTokenRequest, messageSignature?: string | undefined, options?: any): (axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<AccessTokenResponse>;
};
/**
...
export declare const FraudDetectApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    fraudClientRegistrationPost(contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, clientRegistration: ClientRegistration, messageSignature?: string | undefined, region?: string | undefined, options?: any): RequestArgs;
    /**
     ...
     * @throws {RequiredError}
     */
    fraudPaymentRegistrationPost(contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, paymentRegistration: PaymentRegistration, messageSignature?: string | undefined, region?: string | undefined, options?: any): RequestArgs;
    /**
...
export declare const InformationLookupApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    lookupAccount(contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, accountInfoLookupRequest: AccountInfoLookupRequest, messageSignature?: string | undefined, region?: string | undefined, options?: any): RequestArgs;
};
/**
...
export declare const PaymentApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    finalizeSecureTransaction(contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, transactionId: string, authenticationUpdateRequest: AuthenticationUpdateRequest, messageSignature?: string | undefined, region?: string | undefined, options?: any): RequestArgs;
    /**
...
export declare const PaymentSchedulesApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    updatePaymentSchedule(contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, orderId: string, paymentSchedulesRequest: PaymentSchedulesRequest, messageSignature?: string | undefined, region?: string | undefined, options?: any): RequestArgs;
};
/**
...
export declare const PaymentTokenApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    getPaymentTokenDetails(contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, tokenId: string, messageSignature?: string | undefined, authorization?: string | undefined, region?: string | undefined, storeId?: string | undefined, options?: any): RequestArgs;
    /**
     ...
     * @throws {RequiredError}
     */
    updatePaymentToken(contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, paymentCardPaymentTokenUpdateRequest: PaymentCardPaymentTokenUpdateRequest, messageSignature?: string | undefined, authorization?: string | undefined, region?: string | undefined, options?: any): RequestArgs;
};
/**
...
export declare const VerificationApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    verifyAccount(contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, accountVerificationRequest: AccountVerificationRequest, messageSignature?: string | undefined, region?: string | undefined, options?: any): RequestArgs;
    /**
