 ...
 *
 * @export
 * @interface GenerateCertificateFromCsrResponse
 */
export interface GenerateCertificateFromCsrResponse {
    /**
     * Echoes back the value in the request header for tracking.
     * @type {string}
     * @memberof GenerateCertificateFromCsrResponse
     */
    clientRequestId?: string;
    /**
     * Request identifier in API, can be used to request logs from the support team.
    ...
    responseType?: ResponseType;
    /**
     * Certificate file (x509) encoded in Base64.
     * @type {string}
     * @memberof GenerateCertificateFromCsrResponse
     */
    certificate: string;
...
export interface GenerateCertificateResponse {
    ...
    responseType?: ResponseType;
    /**
     * Zip file containing new private key and signed certificate in PKCS#12 and JKS format, encoded in Base64.
     * @type {string}
     * @memberof GenerateCertificateResponse
     */
    zipFile: string;
    /**
     * Password for PKCS#12 / Private Key Password.
     * @type {string}
     * @memberof GenerateCertificateResponse
     */
 ...
 *
 * @export
 * @interface IdealSetupResponse
 */
export interface IdealSetupResponse {
    /**
     * Echoes back the value in the request header for tracking.
     * @type {string}
     * @memberof IdealSetupResponse
     */
    clientRequestId?: string;
    /**
     * Request identifier in API, can be used to request logs from the support team.
 ...
 * Sofort setup.
 * @export
 * @interface SofortSetup
 */
export interface SofortSetup {
    /**
     * Sofort customer identifier.
     * @type {string}
     * @memberof SofortSetup
     */
    customerId: string;
    /**
 ...
 *
 * @export
 * @interface SofortSetupResponse
 */
export interface SofortSetupResponse {
    /**
     * Echoes back the value in the request header for tracking.
     * @type {string}
     * @memberof SofortSetupResponse
     */
    clientRequestId?: string;
    /**
     * Request identifier in API, can be used to request logs from the support team.
