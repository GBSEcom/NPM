...
/**
    ...
    * @enum {string}
    */
export declare enum AVSResponseStreetMatchEnum {
    Y = "Y",
    N = "N",
...
/**
    ...
    * @enum {string}
    */
export declare enum AVSResponsePostalCodeMatchEnum {
    Y = "Y",
    N = "N",
    NOINPUTDATA = "NO_INPUT_DATA",
    NOTCHECKED = "NOT_CHECKED"
 ...
 * @enum {string}
 */
export declare enum AchRecurringType {
    Single = "Single",
    Recurring = "Recurring"
}
/**
...
/**
    ...
    * @enum {string}
    */
export declare enum AdditionalTransactionDetailsDisbursementTransTypeEnum {
    FUNDING = "FUNDING",
...
/**
    ...
    * @enum {string}
    */
export declare enum AdditionalTransactionDetailsWalletProviderEnum {
...
/**
    ...
    * @enum {string}
    */
export declare enum AirlineReservationSystemEnum {
    START = "START",
    TWA = "TWA",
    DELTA = "DELTA",
    SABRE = "SABRE",
...
/**
    ...
    * @enum {string}
    */
export declare enum AirlineAncillaryServiceCategoryServiceCategoryEnum {
...
/**
    ...
    * @enum {string}
    */
export declare enum AirlineTravelRouteStopoverTypeEnum {
    DIRECT = "DIRECT",
    STOPOVER = "STOPOVER"
}
/**
...
/**
    ...
    * @enum {string}
    */
export declare enum AliPayPaymentDataTypeEnum {
    BARCODE = "BARCODE",
    QRCODE = "QRCODE"
}
/**
...
/**
    ...
    * @enum {string}
    */
export declare enum BancontactQRTransactionRoutingMeansEnum {
    QRCode = "QR Code",
...
/**
    ...
    * @enum {string}
    */
export declare enum CarRentalExtraChargesChargeItemEnum {
...
/**
    ...
    * @enum {string}
    */
export declare enum CardInfoCommercialCardEnum {
    CORPORATE = "CORPORATE",
...
/**
    ...
    * @enum {string}
    */
export declare enum CardInfoLookupResponseRequestStatusEnum {
    SUCCESS = "SUCCESS",
...
/**
    ...
    * @enum {string}
    */
export declare enum CardInfoLookupResponseAllOfRequestStatusEnum {
    SUCCESS = "SUCCESS",
    LISTEMPTY = "LIST_EMPTY"
}
/**
...
/**
    ...
    * @enum {string}
    */
export declare enum ChinaDomesticPaymentMethodBrandEnum {
...
/**
    ...
    * @enum {string}
    */
export declare enum ChinaDomesticPaymentMethodAllOfBrandEnum {
    ALIPAYDOMESTIC = "ALIPAY_DOMESTIC",
    CUPDOMESTIC = "CUP_DOMESTIC",
    WECHATDOMESTIC = "WECHAT_DOMESTIC"
}
...
/**
    ...
    * @enum {string}
    */
export declare enum EncryptedApplePayVersionEnum {
    ECV1 = "EC_v1"
}
/**
...
/**
    ...
    * @enum {string}
    */
export declare enum EndpointResponseStatusEnum {
    APPROVED = "APPROVED",
    DECLINED = "DECLINED",
    FAILED = "FAILED"
}
...
/**
    ...
    * @enum {string}
    */
export declare enum FraudRegistrationDeviceDeviceTypeEnum {
    Pos = "device/pos",
    Mobile = "device/mobile"
}
/**
...
/**
    ...
    * @enum {string}
    */
export declare enum FraudRegistrationDeviceItemsNetworkTypeEnum {
...
/**
    ...
    * @enum {string}
    */
export declare enum FraudRegistrationResponseTransactionStatusEnum {
...
/**
    ...
    * @enum {string}
    */
export declare enum FrequencyUnitEnum {
    DAY = "DAY",
    WEEK = "WEEK",
    MONTH = "MONTH",
    YEAR = "YEAR"
...
/**
    ...
    * @enum {string}
    */
export declare enum InitiateClearingResponseRequestStatusEnum {
    SUCCESS = "SUCCESS",
...
/**
    ...
    * @enum {string}
    */
export declare enum InitiateClearingResponseAllOfRequestStatusEnum {
    SUCCESS = "SUCCESS",
    PROCESSINGFAILED = "PROCESSING_FAILED",
    FAILURE = "FAILURE"
}
...
/**
    ...
    * @enum {string}
    */
export declare enum InstallmentOptionsRecurringTypeEnum {
    FIRST = "FIRST",
    REPEAT = "REPEAT",
...
/**
    ...
    * @enum {string}
    */
export declare enum IssuerResponseStatusEnum {
    Approved = "approved",
    Declined = "declined",
    Disabled = "disabled",
    Unknown = "unknown"
...
/**
    ...
    * @enum {string}
    */
export declare enum ItemsNetworkTypeEnum {
    Mobile = "network/mobile",
    Wifi = "network/wifi"
}
/**
...
/**
    ...
    * @enum {string}
    */
export declare enum LodgingExtraChargesChargeItemEnum {
    GIFTSHOP = "GIFT_SHOP",
    LAUNDRY = "LAUNDRY",
    MINIBAR = "MINI_BAR",
...
/**
    ...
    * @enum {string}
    */
export declare enum LogoPositionEnum {
    TOP = "TOP",
    BOTTOM = "BOTTOM"
}
/**
...
/**
    ...
    * @enum {string}
    */
export declare enum MethodMethodTypeEnum {
    Card = "method/card",
...
/**
    ...
    * @enum {string}
    */
export declare enum PaymentEntryMethodEnum {
    Manual = "manual",
    Stripe = "stripe",
    Ocr = "ocr",
    Emv = "emv",
...
/**
    ...
    * @enum {string}
    */
export declare enum PaymentDeviceDeviceTypeEnum {
    SWIPE = "SWIPE"
}
/**
...
/**
    ...
    * @enum {string}
    */
export declare enum PaymentSchedulesErrorResponseRequestStatusEnum {
    SUCCESS = "SUCCESS",
...
/**
    ...
    * @enum {string}
    */
export declare enum PaymentSchedulesResponseRequestStatusEnum {
    SUCCESS = "SUCCESS",
    VALIDATIONFAILED = "VALIDATION_FAILED",
    PROCESSINGFAILED = "PROCESSING_FAILED",
    FAILURE = "FAILURE",
...
/**
    ...
    * @enum {string}
    */
export declare enum PaymentSchedulesResponseAllOfRequestStatusEnum {
    SUCCESS = "SUCCESS",
    VALIDATIONFAILED = "VALIDATION_FAILED",
    PROCESSINGFAILED = "PROCESSING_FAILED",
    FAILURE = "FAILURE",
...
/**
    ...
    * @enum {string}
    */
export declare enum PaymentTokenUpdateResponseRequestStatusEnum {
    FAILED = "FAILED",
    SUCCESS = "SUCCESS",
...
/**
    ...
    * @enum {string}
    */
export declare enum PaymentTokenUpdateResponseAllOfRequestStatusEnum {
    FAILED = "FAILED",
    SUCCESS = "SUCCESS",
    PARTIALSUCCESS = "PARTIAL_SUCCESS"
}
...
/**
    ...
    * @enum {string}
    */
export declare enum PaymentTokenizationErrorResponseRequestStatusEnum {
    DELETED = "DELETED",
    FAILED = "FAILED",
    SUCCESS = "SUCCESS",
    APPROVED = "APPROVED",
...
/**
    ...
    * @enum {string}
    */
export declare enum PaymentTokenizationResponseRequestStatusEnum {
    DELETED = "DELETED",
    FAILED = "FAILED",
    SUCCESS = "SUCCESS",
    APPROVED = "APPROVED",
...
/**
    ...
    * @enum {string}
    */
export declare enum PaymentTokenizationResponseAllOfRequestStatusEnum {
    DELETED = "DELETED",
    FAILED = "FAILED",
    SUCCESS = "SUCCESS",
    APPROVED = "APPROVED",
...
/**
    ...
    * @enum {string}
    */
export declare enum PaymentUrlErrorResponseRequestStatusEnum {
    SUCCESS = "SUCCESS",
    VALIDATIONFAILED = "VALIDATION_FAILED",
    PROCESSINGFAILED = "PROCESSING_FAILED",
    FAILURE = "FAILURE"
...
/**
    ...
    * @enum {string}
    */
export declare enum PaymentUrlResponseRequestStatusEnum {
    SUCCESS = "SUCCESS",
    VALIDATIONFAILED = "VALIDATION_FAILED",
    PROCESSINGFAILED = "PROCESSING_FAILED",
    FAILURE = "FAILURE"
...
/**
    ...
    * @enum {string}
    */
export declare enum PaymentUrlResponseAllOfRequestStatusEnum {
    SUCCESS = "SUCCESS",
    VALIDATIONFAILED = "VALIDATION_FAILED",
    PROCESSINGFAILED = "PROCESSING_FAILED",
    FAILURE = "FAILURE"
 ...
 * @enum {string}
 */
export declare enum PaymentUrlStatus {
    Created = "Created",
    Used = "Used",
    Expired = "Expired",
    Cancelled = "Cancelled"
...
/**
    ...
    * @enum {string}
    */
export declare enum ProcessorDataSecurityCodeResponseEnum {
    MATCHED = "MATCHED",
...
/**
    ...
    * @enum {string}
    */
export declare enum RecurringPaymentDetailsStateEnum {
    Installed = "Installed",
...
/**
    ...
    * @enum {string}
    */
export declare enum RegistrationMethodMethodTypeEnum {
    Card = "method/card",
    Wallet = "method/wallet"
}
/**
...
/**
    ...
    * @enum {string}
    */
export declare enum ScoreOnlyRequestOriginalTransactionTypeEnum {
...
/**
    ...
    * @enum {string}
    */
export declare enum ScoreOnlyResponseTransactionStatusEnum {
    ScoredSuccessfully = "Scored successfully",
    NotProcessed = "Not Processed"
}
/**
...
/**
    ...
    * @enum {string}
    */
export declare enum Secure3D10AuthenticationResultVerificationResponseEnum {
    Y = "Y",
    N = "N",
    U = "U"
}
/**
    ...
    * @enum {string}
    */
export declare enum Secure3D10AuthenticationResultAuthenticationAttemptResultEnum {
    Y = "Y",
    N = "N",
    U = "U",
    A = "A"
...
/**
    ...
    * @enum {string}
    */
export declare enum Secure3D10AuthenticationResultAllOfVerificationResponseEnum {
    Y = "Y",
    N = "N",
    U = "U"
}
/**
    ...
    * @enum {string}
    */
export declare enum Secure3D10AuthenticationResultAllOfAuthenticationAttemptResultEnum {
    Y = "Y",
    N = "N",
    U = "U",
    A = "A"
...
/**
    ...
    * @enum {string}
    */
export declare enum Secure3D21AuthenticationRequestChallengeIndicatorEnum {
    _01 = "01",
    _02 = "02",
    _03 = "03",
    _04 = "04"
...
/**
    ...
    * @enum {string}
    */
export declare enum Secure3D21AuthenticationRequestChallengeWindowSizeEnum {
    _01 = "01",
    _02 = "02",
    _03 = "03",
    _04 = "04",
...
/**
    ...
    * @enum {string}
    */
export declare enum Secure3D21AuthenticationRequestAllOfChallengeIndicatorEnum {
    _01 = "01",
    _02 = "02",
    _03 = "03",
    _04 = "04"
...
/**
    ...
    * @enum {string}
    */
export declare enum Secure3D21AuthenticationRequestAllOfChallengeWindowSizeEnum {
    _01 = "01",
    _02 = "02",
    _03 = "03",
    _04 = "04",
...
/**
    ...
    * @enum {string}
    */
export declare enum Secure3D21AuthenticationResultAuthenticationResponseEnum {
    A = "A",
    N = "N",
    U = "U",
    Y = "Y",
...
/**
    ...
    * @enum {string}
    */
export declare enum Secure3D21AuthenticationResultTransactionStatusEnum {
    A = "A",
    N = "N",
    U = "U",
    Y = "Y",
...
/**
    ...
    * @enum {string}
    */
export declare enum Secure3D21AuthenticationResultAllOfAuthenticationResponseEnum {
    A = "A",
    N = "N",
    U = "U",
    Y = "Y",
...
/**
    ...
    * @enum {string}
    */
export declare enum Secure3D21AuthenticationResultAllOfTransactionStatusEnum {
    A = "A",
    N = "N",
    U = "U",
    Y = "Y",
...
/**
    ...
    * @enum {string}
    */
export declare enum Secure3D21AuthenticationUpdateRequestMethodNotificationStatusEnum {
    RECEIVED = "RECEIVED",
...
/**
    ...
    * @enum {string}
    */
export declare enum Secure3D21AuthenticationUpdateRequestAllOfMethodNotificationStatusEnum {
    RECEIVED = "RECEIVED",
    EXPECTEDBUTNOTRECEIVED = "EXPECTED_BUT_NOT_RECEIVED",
    NOTEXPECTED = "NOT_EXPECTED"
}
...
/**
    ...
    * @enum {string}
    */
export declare enum Secure3DAuthenticationResponseTypeEnum {
    _3DSECURE = "3D_SECURE"
}
/**
    * @export
    * @enum {string}
    */
export declare enum Secure3DAuthenticationResponseVersionEnum {
    _10 = "1.0",
    _21 = "2.1",
    _22 = "2.2"
}
...
/**
    ...
    * @enum {string}
    */
export declare enum SepaMandateTypeEnum {
    SINGLE = "SINGLE",
...
/**
    ...
    * @enum {string}
    */
export declare enum StoredCredentialSequenceEnum {
    FIRST = "FIRST",
...
/**
    ...
    * @enum {string}
    */
export declare enum StoredCredentialInitiatorEnum {
    MERCHANT = "MERCHANT",
...
/**
    ...
    * @enum {string}
    */
export declare enum TeleCheckAchPaymentMethodAccountTypeEnum {
    C = "C",
    S = "S"
}
/**
    ...
    * @enum {string}
    */
export declare enum TeleCheckAchPaymentMethodCheckTypeEnum {
    P = "P",
    C = "C"
}
/**
    ...
    * @enum {string}
    */
export declare enum TeleCheckAchPaymentMethodReleaseTypeEnum {
    C = "C",
    D = "D",
    P = "P",
    T = "T"
...
/**
    ...
    * @enum {string}
    */
export declare enum TeleCheckAchPaymentMethodVipCustomerEnum {
    Y = "Y",
    N = "N"
}
/**
...
/**
    ...
    * @enum {string}
    */
export declare enum TransactionErrorResponseTransactionStatusEnum {
    APPROVED = "APPROVED",
    WAITING = "WAITING",
    VALIDATIONFAILED = "VALIDATION_FAILED",
    PROCESSINGFAILED = "PROCESSING_FAILED",
...
/**
    ...
    * @enum {string}
    */
export declare enum TransactionErrorResponseTransactionStateEnum {
...
/**
    ...
    * @enum {string}
    */
export declare enum TransactionResponseTransactionStatusEnum {
    APPROVED = "APPROVED",
    WAITING = "WAITING",
    VALIDATIONFAILED = "VALIDATION_FAILED",
    PROCESSINGFAILED = "PROCESSING_FAILED",
...
/**
    ...
    * @enum {string}
    */
export declare enum TransactionResponseTransactionStateEnum {
    AUTHORIZED = "AUTHORIZED",
    CAPTURED = "CAPTURED",
    DECLINED = "DECLINED",
    CHECKED = "CHECKED",
...
/**
    ...
    * @enum {string}
    */
export declare enum TransactionResponseAllOfTransactionStatusEnum {
    APPROVED = "APPROVED",
    WAITING = "WAITING",
    VALIDATIONFAILED = "VALIDATION_FAILED",
    PROCESSINGFAILED = "PROCESSING_FAILED",
...
/**
    ...
    * @enum {string}
    */
export declare enum TransactionResponseAllOfTransactionStateEnum {
    AUTHORIZED = "AUTHORIZED",
    CAPTURED = "CAPTURED",
    DECLINED = "DECLINED",
    CHECKED = "CHECKED",
...
export declare const AuthenticationApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
     ...
     */
    authenticationAccessTokensPost: (contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, accessTokenRequest: AccessTokenRequest, messageSignature?: string | undefined, options?: any) => Promise<RequestArgs>;
};
/**
...
export declare const AuthenticationApiFp: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    authenticationAccessTokensPost(contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, accessTokenRequest: AccessTokenRequest, messageSignature?: string | undefined, options?: any): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<AccessTokenResponse>>;
};
/**
...
export declare const AuthenticationApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
     ...
     * @throws {RequiredError}
     */
    authenticationAccessTokensPost(contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, accessTokenRequest: AccessTokenRequest, messageSignature?: string | undefined, options?: any): AxiosPromise<AccessTokenResponse>;
};
/**
...
export declare class AuthenticationApi extends BaseAPI implements AuthenticationApiInterface {
     ...
     */
    authenticationAccessTokensPost(contentType: 'application/json', clientRequestId: string, apiKey: string, timestamp: number, accessTokenRequest: AccessTokenRequest, messageSignature?: string, options?: any): Promise<import("axios").AxiosResponse<AccessTokenResponse>>;
}
/**
...
export declare const CurrencyConversionApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    getExchangeRate: (contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, exchangeRateRequest: ExchangeRateRequest, messageSignature?: string | undefined, region?: string | undefined, options?: any) => Promise<RequestArgs>;
};
/**
...
export declare const CurrencyConversionApiFp: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    getExchangeRate(contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, exchangeRateRequest: ExchangeRateRequest, messageSignature?: string | undefined, region?: string | undefined, options?: any): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<ExchangeRateResponse>>;
};
/**
...
export declare class CurrencyConversionApi extends BaseAPI implements CurrencyConversionApiInterface {
     ...
     */
    getExchangeRate(contentType: 'application/json', clientRequestId: string, apiKey: string, timestamp: number, exchangeRateRequest: ExchangeRateRequest, messageSignature?: string, region?: string, options?: any): Promise<import("axios").AxiosResponse<ExchangeRateResponse>>;
}
/**
...
export declare const FraudDetectApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    fraudClientRegistrationPost: (contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, clientRegistration: ClientRegistration, messageSignature?: string | undefined, region?: string | undefined, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    fraudPaymentRegistrationPost: (contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, paymentRegistration: PaymentRegistration, messageSignature?: string | undefined, region?: string | undefined, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    scoreOnly: (contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, scoreOnlyRequest: ScoreOnlyRequest, messageSignature?: string | undefined, region?: string | undefined, options?: any) => Promise<RequestArgs>;
};
/**
...
export declare const FraudDetectApiFp: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    fraudClientRegistrationPost(contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, clientRegistration: ClientRegistration, messageSignature?: string | undefined, region?: string | undefined, options?: any): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<FraudRegistrationResponse>>;
    /**
     * Use this to register payment for fraud detect transaction.
     * @summary Payment registration for fraud detect transaction.
     * @param {'application/json'} contentType Content type.
     ...
     * @throws {RequiredError}
     */
    fraudPaymentRegistrationPost(contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, paymentRegistration: PaymentRegistration, messageSignature?: string | undefined, region?: string | undefined, options?: any): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<FraudRegistrationResponse>>;
    /**
     * Use this to obtain a fraud score for a transaction.
     * @summary Score a transaction for fraud.
     * @param {'application/json'} contentType Content type.
     ...
     * @throws {RequiredError}
     */
    scoreOnly(contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, scoreOnlyRequest: ScoreOnlyRequest, messageSignature?: string | undefined, region?: string | undefined, options?: any): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<ScoreOnlyResponse>>;
};
/**
...
export declare const FraudDetectApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
     ...
     * @throws {RequiredError}
     */
    fraudClientRegistrationPost(contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, clientRegistration: ClientRegistration, messageSignature?: string | undefined, region?: string | undefined, options?: any): AxiosPromise<FraudRegistrationResponse>;
    /**
     * Use this to register payment for fraud detect transaction.
     * @summary Payment registration for fraud detect transaction.
     * @param {'application/json'} contentType Content type.
     ...
     * @throws {RequiredError}
     */
    fraudPaymentRegistrationPost(contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, paymentRegistration: PaymentRegistration, messageSignature?: string | undefined, region?: string | undefined, options?: any): AxiosPromise<FraudRegistrationResponse>;
    /**
     * Use this to obtain a fraud score for a transaction.
     * @summary Score a transaction for fraud.
     * @param {'application/json'} contentType Content type.
...
export declare class FraudDetectApi extends BaseAPI implements FraudDetectApiInterface {
     ...
     */
    fraudClientRegistrationPost(contentType: 'application/json', clientRequestId: string, apiKey: string, timestamp: number, clientRegistration: ClientRegistration, messageSignature?: string, region?: string, options?: any): Promise<import("axios").AxiosResponse<FraudRegistrationResponse>>;
    /**
     * Use this to register payment for fraud detect transaction.
     * @summary Payment registration for fraud detect transaction.
     * @param {'application/json'} contentType Content type.
     ...
     * @memberof FraudDetectApi
     */
    fraudPaymentRegistrationPost(contentType: 'application/json', clientRequestId: string, apiKey: string, timestamp: number, paymentRegistration: PaymentRegistration, messageSignature?: string, region?: string, options?: any): Promise<import("axios").AxiosResponse<FraudRegistrationResponse>>;
    /**
     * Use this to obtain a fraud score for a transaction.
     * @summary Score a transaction for fraud.
     * @param {'application/json'} contentType Content type.
     ...
     * @memberof FraudDetectApi
     */
    scoreOnly(contentType: 'application/json', clientRequestId: string, apiKey: string, timestamp: number, scoreOnlyRequest: ScoreOnlyRequest, messageSignature?: string, region?: string, options?: any): Promise<import("axios").AxiosResponse<ScoreOnlyResponse>>;
}
/**
 * InformationLookupApi - axios parameter creator
 * @export
 */
export declare const InformationLookupApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
    /**
     ...
     * @throws {RequiredError}
     */
    cardInfoLookup: (contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, cardInfoLookupRequest: CardInfoLookupRequest, messageSignature?: string | undefined, region?: string | undefined, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    lookupAccount: (contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, accountInfoLookupRequest: AccountInfoLookupRequest, messageSignature?: string | undefined, region?: string | undefined, options?: any) => Promise<RequestArgs>;
};
/**
 * InformationLookupApi - functional programming interface
 * @export
 */
export declare const InformationLookupApiFp: (configuration?: Configuration | undefined) => {
    /**
     * Use this to look up card related information such as issuer country, card function and card brand.
     * @summary Card information lookup.
     * @param {'application/json'} contentType Content type.
     ...
     * @throws {RequiredError}
     */
    lookupAccount(contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, accountInfoLookupRequest: AccountInfoLookupRequest, messageSignature?: string | undefined, region?: string | undefined, options?: any): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<CardInfoLookupResponse>>;
};
/**
 * InformationLookupApi - factory interface
 * @export
 */
export declare const InformationLookupApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
    /**
     * Use this to look up card related information such as issuer country, card function and card brand.
     * @summary Card information lookup.
     * @param {'application/json'} contentType Content type.
     ...
     * @throws {RequiredError}
     */
    lookupAccount(contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, accountInfoLookupRequest: AccountInfoLookupRequest, messageSignature?: string | undefined, region?: string | undefined, options?: any): AxiosPromise<CardInfoLookupResponse>;
};
/**
 ...
 * @extends {BaseAPI}
 */
export declare class InformationLookupApi extends BaseAPI implements InformationLookupApiInterface {
    /**
     * Use this to look up card related information such as issuer country, card function and card brand.
     * @summary Card information lookup.
     * @param {'application/json'} contentType Content type.
     ...
     */
    cardInfoLookup(contentType: 'application/json', clientRequestId: string, apiKey: string, timestamp: number, cardInfoLookupRequest: CardInfoLookupRequest, messageSignature?: string, region?: string, options?: any): Promise<import("axios").AxiosResponse<CardInfoLookupResponse>>;
    /**
     * Use this to look up card related information associated with a payment card or payment token.
     * @summary Account information lookup.
     * @param {'application/json'} contentType Content type.
     ...
     * @memberof InformationLookupApi
     */
    lookupAccount(contentType: 'application/json', clientRequestId: string, apiKey: string, timestamp: number, accountInfoLookupRequest: AccountInfoLookupRequest, messageSignature?: string, region?: string, options?: any): Promise<import("axios").AxiosResponse<CardInfoLookupResponse>>;
}
/**
...
export declare const OrderApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    orderInquiry: (contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, orderId: string, messageSignature?: string | undefined, region?: string | undefined, storeId?: string | undefined, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    submitSecondaryTransactionFromOrder: (contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, orderId: string, secondaryTransaction: SecondaryTransaction, messageSignature?: string | undefined, region?: string | undefined, options?: any) => Promise<RequestArgs>;
};
/**
...
export declare const OrderApiFp: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    orderInquiry(contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, orderId: string, messageSignature?: string | undefined, region?: string | undefined, storeId?: string | undefined, options?: any): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<OrderResponse>>;
    /**
     * Use this to perform a postAuth or return secondary transaction using order ID. Partial postAuths and returns are allowed.
     * @summary Perform return or postAuth secondary transactions.
     * @param {'application/json'} contentType Content type.
...
export declare class OrderApi extends BaseAPI implements OrderApiInterface {
     ...
     * @memberof OrderApi
     */
    orderInquiry(contentType: 'application/json', clientRequestId: string, apiKey: string, timestamp: number, orderId: string, messageSignature?: string, region?: string, storeId?: string, options?: any): Promise<import("axios").AxiosResponse<OrderResponse>>;
    /**
     * Use this to perform a postAuth or return secondary transaction using order ID. Partial postAuths and returns are allowed.
     * @summary Perform return or postAuth secondary transactions.
     * @param {'application/json'} contentType Content type.
     ...
     * @memberof OrderApi
     */
    submitSecondaryTransactionFromOrder(contentType: 'application/json', clientRequestId: string, apiKey: string, timestamp: number, orderId: string, secondaryTransaction: SecondaryTransaction, messageSignature?: string, region?: string, options?: any): Promise<import("axios").AxiosResponse<TransactionResponse>>;
}
/**
...
export declare const PaymentApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    finalizeSecureTransaction: (contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, transactionId: string, authenticationUpdateRequest: AuthenticationUpdateRequest, messageSignature?: string | undefined, region?: string | undefined, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    submitPrimaryTransaction: (contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, primaryTransaction: PrimaryTransaction, messageSignature?: string | undefined, region?: string | undefined, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    submitSecondaryTransaction: (contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, transactionId: string, secondaryTransaction: SecondaryTransaction, messageSignature?: string | undefined, region?: string | undefined, storeId?: string | undefined, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    transactionInquiry: (contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, transactionId: string, messageSignature?: string | undefined, region?: string | undefined, storeId?: string | undefined, options?: any) => Promise<RequestArgs>;
};
/**
...
export declare const PaymentApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
     ...
     * @throws {RequiredError}
     */
    finalizeSecureTransaction(contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, transactionId: string, authenticationUpdateRequest: AuthenticationUpdateRequest, messageSignature?: string | undefined, region?: string | undefined, options?: any): AxiosPromise<TransactionResponse>;
    /**
     * Use this to originate a financial transaction like a sale, preauthorization, or credit.
     * @summary Generate a primary transaction.
     * @param {'application/json'} contentType Content type.
...
export declare class PaymentApi extends BaseAPI implements PaymentApiInterface {
     ...
     * @memberof PaymentApi
     */
    finalizeSecureTransaction(contentType: 'application/json', clientRequestId: string, apiKey: string, timestamp: number, transactionId: string, authenticationUpdateRequest: AuthenticationUpdateRequest, messageSignature?: string, region?: string, options?: any): Promise<import("axios").AxiosResponse<TransactionResponse>>;
    /**
     * Use this to originate a financial transaction like a sale, preauthorization, or credit.
     * @summary Generate a primary transaction.
     * @param {'application/json'} contentType Content type.
     ...
     * @memberof PaymentApi
     */
    submitPrimaryTransaction(contentType: 'application/json', clientRequestId: string, apiKey: string, timestamp: number, primaryTransaction: PrimaryTransaction, messageSignature?: string, region?: string, options?: any): Promise<import("axios").AxiosResponse<TransactionResponse>>;
    /**
     * Use this to perform a void, postAuth or return secondary transaction. Partial postAuths and returns are allowed.
     * @summary Perform a secondary transaction.
     * @param {'application/json'} contentType Content type.
     ...
     * @memberof PaymentApi
     */
    submitSecondaryTransaction(contentType: 'application/json', clientRequestId: string, apiKey: string, timestamp: number, transactionId: string, secondaryTransaction: SecondaryTransaction, messageSignature?: string, region?: string, storeId?: string, options?: any): Promise<import("axios").AxiosResponse<TransactionResponse>>;
    /**
     * Use this query to get the current state of an existing transaction.
     * @summary Retrieve the state of a transaction.
     * @param {'application/json'} contentType Content type.
     ...
     * @memberof PaymentApi
     */
    transactionInquiry(contentType: 'application/json', clientRequestId: string, apiKey: string, timestamp: number, transactionId: string, messageSignature?: string, region?: string, storeId?: string, options?: any): Promise<import("axios").AxiosResponse<TransactionResponse>>;
}
/**
...
export declare const PaymentSchedulesApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    cancelPaymentSchedule: (contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, orderId: string, messageSignature?: string | undefined, region?: string | undefined, storeId?: string | undefined, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    createPaymentSchedule: (contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, paymentSchedulesRequest: PaymentSchedulesRequest, messageSignature?: string | undefined, region?: string | undefined, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    inquiryPaymentSchedule: (contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, orderId: string, messageSignature?: string | undefined, region?: string | undefined, storeId?: string | undefined, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    updatePaymentSchedule: (contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, orderId: string, paymentSchedulesRequest: PaymentSchedulesRequest, messageSignature?: string | undefined, region?: string | undefined, options?: any) => Promise<RequestArgs>;
};
/**
...
export declare const PaymentSchedulesApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
     ...
     * @throws {RequiredError}
     */
    updatePaymentSchedule(contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, orderId: string, paymentSchedulesRequest: PaymentSchedulesRequest, messageSignature?: string | undefined, region?: string | undefined, options?: any): AxiosPromise<PaymentSchedulesResponse>;
};
/**
...
export declare class PaymentSchedulesApi extends BaseAPI implements PaymentSchedulesApiInterface {
     ...
     */
    cancelPaymentSchedule(contentType: 'application/json', clientRequestId: string, apiKey: string, timestamp: number, orderId: string, messageSignature?: string, region?: string, storeId?: string, options?: any): Promise<import("axios").AxiosResponse<PaymentSchedulesResponse>>;
    /**
     * Use this to create a gateway payment schedule.
     * @summary Create gateway payment schedule.
     * @param {'application/json'} contentType Content type.
     ...
     * @memberof PaymentSchedulesApi
     */
    createPaymentSchedule(contentType: 'application/json', clientRequestId: string, apiKey: string, timestamp: number, paymentSchedulesRequest: PaymentSchedulesRequest, messageSignature?: string, region?: string, options?: any): Promise<import("axios").AxiosResponse<PaymentSchedulesResponse>>;
    /**
     * Use this to view an existing gateway payment schedule.
     * @summary View a gateway payment schedule.
     * @param {'application/json'} contentType Content type.
     ...
     * @memberof PaymentSchedulesApi
     */
    inquiryPaymentSchedule(contentType: 'application/json', clientRequestId: string, apiKey: string, timestamp: number, orderId: string, messageSignature?: string, region?: string, storeId?: string, options?: any): Promise<import("axios").AxiosResponse<RecurringPaymentDetailsResponse>>;
    /**
     * Use this to update a gateway payment schedule.
     * @summary Update a gateway payment schedule.
     * @param {'application/json'} contentType Content type.
     ...
     * @memberof PaymentSchedulesApi
     */
    updatePaymentSchedule(contentType: 'application/json', clientRequestId: string, apiKey: string, timestamp: number, orderId: string, paymentSchedulesRequest: PaymentSchedulesRequest, messageSignature?: string, region?: string, options?: any): Promise<import("axios").AxiosResponse<PaymentSchedulesResponse>>;
}
/**
...
export declare const PaymentTokenApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    createPaymentToken: (contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, paymentTokenizationRequest: PaymentTokenizationRequest, messageSignature?: string | undefined, authorization?: string | undefined, region?: string | undefined, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    deletePaymentToken: (contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, tokenId: string, messageSignature?: string | undefined, authorization?: string | undefined, region?: string | undefined, storeId?: string | undefined, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getPaymentTokenDetails: (contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, tokenId: string, messageSignature?: string | undefined, authorization?: string | undefined, region?: string | undefined, storeId?: string | undefined, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    updatePaymentToken: (contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, paymentCardPaymentTokenUpdateRequest: PaymentCardPaymentTokenUpdateRequest, messageSignature?: string | undefined, authorization?: string | undefined, region?: string | undefined, options?: any) => Promise<RequestArgs>;
};
/**
...
export declare const PaymentTokenApiFp: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    getPaymentTokenDetails(contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, tokenId: string, messageSignature?: string | undefined, authorization?: string | undefined, region?: string | undefined, storeId?: string | undefined, options?: any): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<PaymentTokenizationResponse>>;
    /**
     * Use this update one or more payment tokens.
     * @summary Update one or more payment tokens.
     * @param {'application/json'} contentType Content type.
     ...
     * @throws {RequiredError}
     */
    updatePaymentToken(contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, paymentCardPaymentTokenUpdateRequest: PaymentCardPaymentTokenUpdateRequest, messageSignature?: string | undefined, authorization?: string | undefined, region?: string | undefined, options?: any): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<PaymentTokenUpdateResponse>>;
};
/**
...
export declare const PaymentTokenApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
     ...
     * @throws {RequiredError}
     */
    getPaymentTokenDetails(contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, tokenId: string, messageSignature?: string | undefined, authorization?: string | undefined, region?: string | undefined, storeId?: string | undefined, options?: any): AxiosPromise<PaymentTokenizationResponse>;
    /**
     * Use this update one or more payment tokens.
     * @summary Update one or more payment tokens.
     * @param {'application/json'} contentType Content type.
     ...
     * @throws {RequiredError}
     */
    updatePaymentToken(contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, paymentCardPaymentTokenUpdateRequest: PaymentCardPaymentTokenUpdateRequest, messageSignature?: string | undefined, authorization?: string | undefined, region?: string | undefined, options?: any): AxiosPromise<PaymentTokenUpdateResponse>;
};
/**
...
export declare class PaymentTokenApi extends BaseAPI implements PaymentTokenApiInterface {
     ...
     */
    createPaymentToken(contentType: 'application/json', clientRequestId: string, apiKey: string, timestamp: number, paymentTokenizationRequest: PaymentTokenizationRequest, messageSignature?: string, authorization?: string, region?: string, options?: any): Promise<import("axios").AxiosResponse<PaymentTokenizationResponse>>;
    /**
     * Use this to delete a payment token.
     * @summary Delete a payment token.
     * @param {'application/json'} contentType Content type.
     ...
     * @memberof PaymentTokenApi
     */
    deletePaymentToken(contentType: 'application/json', clientRequestId: string, apiKey: string, timestamp: number, tokenId: string, messageSignature?: string, authorization?: string, region?: string, storeId?: string, options?: any): Promise<import("axios").AxiosResponse<PaymentTokenizationResponse>>;
    /**
     * Get payment card details associated with token.
     * @summary Get payment card details associated with token.
     * @param {'application/json'} contentType Content type.
     ...
     * @memberof PaymentTokenApi
     */
    getPaymentTokenDetails(contentType: 'application/json', clientRequestId: string, apiKey: string, timestamp: number, tokenId: string, messageSignature?: string, authorization?: string, region?: string, storeId?: string, options?: any): Promise<import("axios").AxiosResponse<PaymentTokenizationResponse>>;
    /**
     * Use this update one or more payment tokens.
     * @summary Update one or more payment tokens.
     * @param {'application/json'} contentType Content type.
...
export declare const PaymentURLApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    createPaymentUrl: (contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, paymentUrlRequest: PaymentUrlRequest, messageSignature?: string | undefined, region?: string | undefined, options?: any) => Promise<RequestArgs>;
    /**
...
export declare const PaymentURLApiFp: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    createPaymentUrl(contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, paymentUrlRequest: PaymentUrlRequest, messageSignature?: string | undefined, region?: string | undefined, options?: any): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<PaymentUrlResponse>>;
    /**
     * Use this to delete an embedding payment link.
     * @summary Delete a payment URL.
     * @param {'application/json'} contentType Content type.
     ...
     * @throws {RequiredError}
     */
    paymentUrlDetail(contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, fromDate: string, toDate: string, messageSignature?: string | undefined, region?: string | undefined, storeId?: string | undefined, orderId?: string | undefined, merchantTransactionId?: string | undefined, status?: string | undefined, options?: any): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<PaymentUrlDetailResponse>>;
};
/**
...
export declare const PaymentURLApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
     ...
     * @throws {RequiredError}
     */
    deletePaymentUrl(contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, messageSignature?: string | undefined, region?: string | undefined, storeId?: string | undefined, transactionId?: string | undefined, orderId?: string | undefined, paymentUrlId?: string | undefined, transactionTime?: string | undefined, options?: any): AxiosPromise<PaymentUrlResponse>;
    /**
     * Use this query to get the current state of an existing paymentURL.
     * @summary Retrieve the state of payment URL.
     * @param {'application/json'} contentType Content type.
     ...
     * @throws {RequiredError}
     */
    paymentUrlDetail(contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, fromDate: string, toDate: string, messageSignature?: string | undefined, region?: string | undefined, storeId?: string | undefined, orderId?: string | undefined, merchantTransactionId?: string | undefined, status?: string | undefined, options?: any): AxiosPromise<PaymentUrlDetailResponse>;
};
/**
...
export declare class PaymentURLApi extends BaseAPI implements PaymentURLApiInterface {
     ...
     */
    createPaymentUrl(contentType: 'application/json', clientRequestId: string, apiKey: string, timestamp: number, paymentUrlRequest: PaymentUrlRequest, messageSignature?: string, region?: string, options?: any): Promise<import("axios").AxiosResponse<PaymentUrlResponse>>;
    /**
     * Use this to delete an embedding payment link.
     * @summary Delete a payment URL.
     * @param {'application/json'} contentType Content type.
     ...
     * @memberof PaymentURLApi
     */
    deletePaymentUrl(contentType: 'application/json', clientRequestId: string, apiKey: string, timestamp: number, messageSignature?: string, region?: string, storeId?: string, transactionId?: string, orderId?: string, paymentUrlId?: string, transactionTime?: string, options?: any): Promise<import("axios").AxiosResponse<PaymentUrlResponse>>;
    /**
     * Use this query to get the current state of an existing paymentURL.
     * @summary Retrieve the state of payment URL.
     * @param {'application/json'} contentType Content type.
     ...
     * @memberof PaymentURLApi
     */
    paymentUrlDetail(contentType: 'application/json', clientRequestId: string, apiKey: string, timestamp: number, fromDate: string, toDate: string, messageSignature?: string, region?: string, storeId?: string, orderId?: string, merchantTransactionId?: string, status?: string, options?: any): Promise<import("axios").AxiosResponse<PaymentUrlDetailResponse>>;
}
/**
 * VerificationApi - axios parameter creator
 * @export
 */
export declare const VerificationApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
    /**
     ...
     * @throws {RequiredError}
     */
    verifyAccount: (contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, accountVerificationRequest: AccountVerificationRequest, messageSignature?: string | undefined, region?: string | undefined, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    verifyCard: (contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, cardVerificationRequest: CardVerificationRequest, messageSignature?: string | undefined, region?: string | undefined, options?: any) => Promise<RequestArgs>;
};
/**
 * VerificationApi - functional programming interface
 * @export
 */
export declare const VerificationApiFp: (configuration?: Configuration | undefined) => {
    /**
     * Use this to perform an account verification for a payment card or payment token.
     * @summary Verify a payment card or payment token.
     * @param {'application/json'} contentType Content type.
     ...
     * @throws {RequiredError}
     */
    verifyAccount(contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, accountVerificationRequest: AccountVerificationRequest, messageSignature?: string | undefined, region?: string | undefined, options?: any): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<TransactionResponse>>;
    /**
     * Use this to perform card verification for a payment card. Use the account-verification endpoint instead for this request.
     * @summary Verify a payment card.
     * @param {'application/json'} contentType Content type.
     ...
     * @throws {RequiredError}
     */
    verifyCard(contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, cardVerificationRequest: CardVerificationRequest, messageSignature?: string | undefined, region?: string | undefined, options?: any): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<TransactionResponse>>;
};
/**
 * VerificationApi - factory interface
 * @export
 */
export declare const VerificationApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
    /**
     * Use this to perform an account verification for a payment card or payment token.
     * @summary Verify a payment card or payment token.
     * @param {'application/json'} contentType Content type.
     ...
     * @throws {RequiredError}
     */
    verifyAccount(contentType: "application/json", clientRequestId: string, apiKey: string, timestamp: number, accountVerificationRequest: AccountVerificationRequest, messageSignature?: string | undefined, region?: string | undefined, options?: any): AxiosPromise<TransactionResponse>;
    /**
     * Use this to perform card verification for a payment card. Use the account-verification endpoint instead for this request.
     * @summary Verify a payment card.
     * @param {'application/json'} contentType Content type.
 ...
 * @extends {BaseAPI}
 */
export declare class VerificationApi extends BaseAPI implements VerificationApiInterface {
    /**
     * Use this to perform an account verification for a payment card or payment token.
     * @summary Verify a payment card or payment token.
     * @param {'application/json'} contentType Content type.
     ...
     */
    verifyAccount(contentType: 'application/json', clientRequestId: string, apiKey: string, timestamp: number, accountVerificationRequest: AccountVerificationRequest, messageSignature?: string, region?: string, options?: any): Promise<import("axios").AxiosResponse<TransactionResponse>>;
    /**
     * Use this to perform card verification for a payment card. Use the account-verification endpoint instead for this request.
     * @summary Verify a payment card.
     * @param {'application/json'} contentType Content type.
     ...
     * @memberof VerificationApi
     */
    verifyCard(contentType: 'application/json', clientRequestId: string, apiKey: string, timestamp: number, cardVerificationRequest: CardVerificationRequest, messageSignature?: string, region?: string, options?: any): Promise<import("axios").AxiosResponse<TransactionResponse>>;
}
